...
<crud
    name="rols"
    :resource="{default: 'rols', get: 'get-rols'}"
    :init-values="{rol_permissions: [], can_manage: '{!! $can_manage ?? false !!}' , can_generate_reports: '{!! $can_generate_reports ?? false !!}'}"
    inline-template>
    <div>
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">Administración de roles</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20" style="margin-bottom: 10px;">
            <button v-if="initValues.can_manage" @click="add()" type="button" class="btn btn-add mr-2" data-backdrop="static" data-target="#modal-form-rols" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('Roles')
            </button>
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('roles'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <small>Filtrar por el nombre del rol</small>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="panel-body">
                ...
                @include('improvementplans::rols.table')
            </div>
        ...
        <!-- begin #modal-view-rols -->
        <div class="modal fade" id="modal-view-rols">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('rol')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('improvementplans::rols.show_fields')
                    </div>
        ...
        <!-- begin #modal-form-rols -->
        <div class="modal fade" id="modal-form-rols">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-rols">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('rol')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('improvementplans::rols.fields')
                        </div>
                        <div class="modal-footer">
                            <button @click="clearDataForm()" class="btn btn-white" data-dismiss="modal"><i class="fa fa-times mr-2"></i>@lang('crud.close')</button>
                            <button type="submit" class="btn btn-add"><i class="fa fa-save mr-2"></i>Crear rol</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $('#modal-form-rols').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
