...
<crud
    ...
    <div>
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">Administración de usuarios</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20 mb-3">
            <button v-if="initValues.can_manage" @click="add()" type="button" class="btn btn-add mr-2" data-backdrop="static" data-target="#modal-form-users" data-toggle="modal">
                <i class="fas fa-user-plus mr-2"></i>@lang('crud.create') @lang('usuario')
            </button>
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('usuarios'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <small>Filtrar por el nombre del usuario</small>
                            </div>
                            <div class="col-md-4">
                                {!! Form::text('name', null, ['v-model' => 'searchFields.email', 'class' => 'form-control']) !!}
                                <small>Filtrar por el correo del usuario</small>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="panel-body">
                ...
                @include('improvementplans::users.table')
            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('usuario')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('improvementplans::users.show_fields')
                    </div>
        ...
        <div class="modal fade" id="modal-form-users">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-users">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('usuario')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('improvementplans::users.fields')
                        </div>
                        <div class="modal-footer">
...
<script>
    ...
    $('#modal-form-users').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
