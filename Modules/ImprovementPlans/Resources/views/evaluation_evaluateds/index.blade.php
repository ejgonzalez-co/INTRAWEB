...
<crud
    name="evaluationEvaluateds"
    :resource="{default: 'my-evaluations', get: 'get-my-evaluations'}"
    :init-values="{can_manage: '{!! $can_manage ?? false !!}' , can_generate_reports: '{!! $can_generate_reports ?? false !!}'}"
    inline-template>
    <div>
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">Mis evaluaciones</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20" style="margin-bottom: 10px;">
            <a href="calendar-evaluations" class="btn btn-light border"><i class="fas fa-calendar-alt mr-2"></i> @lang('Ver calendario')</a>
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('Cantidad de evaluaciones'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
            ...
            <div class="panel-body">
                ...
                @include('improvementplans::evaluation_evaluateds.table')
            </div>
        ...
        <!-- begin #modal-view-evaluationEvaluateds -->
        <div class="modal fade" id="modal-view-evaluationEvaluateds">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('la evaluación')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('improvementplans::evaluation_evaluateds.show_fields')
                    </div>
        ...
        <!-- end #modal-view-evaluationEvaluateds -->

        <!-- begin #modal-form-evaluationEvaluateds -->
        <div class="modal fade" id="modal-form-evaluationEvaluateds">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-evaluationEvaluateds">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('evaluationEvaluateds')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('improvementplans::evaluation_evaluateds.fields')
                        </div>
                        <div class="modal-footer">
        ...
        <!-- end #modal-form-evaluationEvaluateds -->
    </div>
</crud>
@endsection
...
<script>
    ...
    $('#modal-form-evaluationEvaluateds').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
