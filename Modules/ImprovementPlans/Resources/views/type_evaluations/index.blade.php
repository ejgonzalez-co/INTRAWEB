...
@section('title', trans('Tipos de evaluación'))
...
<crud
    ...
    :resource="{default: 'type-evaluations', get: 'get-typeEvaluations'}"
    :init-values="{can_manage: '{!! $can_manage ?? false !!}' , can_generate_reports: '{!! $can_generate_reports ?? false !!}'}"
    inline-template>
    <div>
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">Administración de tipos de evaluación</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20" style="margin-bottom: 10px;">
            <button v-if="initValues.can_manage" @click="add()" type="button" class="btn btn-add m-b-10" data-backdrop="static" data-target="#modal-form-typeEvaluations" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('tipo de evaluación')
            </button>
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('tipos de evaluación'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <small>Filtrar por el tipo de evaluación</small>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="panel-body">
                ...
                @include('improvementplans::type_evaluations.table')
            </div>
        ...
        <!-- begin #modal-view-typeEvaluations -->
        <div class="modal fade" id="modal-view-typeEvaluations">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('tipo de evaluación')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('improvementplans::type_evaluations.show_fields')
                    </div>
        ...
        <!-- end #modal-view-typeEvaluations -->

        <!-- begin #modal-form-typeEvaluations -->
        <div class="modal fade" id="modal-form-typeEvaluations">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-typeEvaluations">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('tipo de evaluación')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('improvementplans::type_evaluations.fields')
                        </div>
                        <div class="modal-footer">
        ...
        <!-- end #modal-form-typeEvaluations -->
    </div>
</crud>
@endsection
...
<script>
    ...
    $('#modal-form-typeEvaluations').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
