    ...
    <div class="panel-body">
        <div class="form-group row m-b-15">
            <dynamic-list label-button-add="Agregar actividad"
                :data-list.sync="dataForm.activities_plans_processing"
                :data-list-options="[
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-5">
                            <select-check css-class="form-control" :key="keyRefresh" name-field="activity_name" reduce-label="activity_name"
                                reduce-key="activity_name" :name-resource="'evaluation-activities-select/'+dataForm.id" :value="dataForm" :is-required="true" :enable-search="true">
                            </select-check>
