<div class="table-responsive">
    <table-component id="evaluationCriterias-table" :data="advancedSearchFilterPaginate()" sort-by="evaluationCriterias"
        ...
        <table-column label="@lang('crud.action')" :sortable="false" :filterable="false">
            <template slot-scope="row">
                ...
                <button v-if="initValues.can_manage" @click="edit(row)" data-backdrop="static" data-target="#modal-form-evaluationCriterias"
                    data-toggle="modal" class="btn btn-white btn-icon btn-md" data-toggle="tooltip" data-placement="top"
                    title="@lang('crud.edit')">
                    <i class="fas fa-pencil-alt"></i>
                </button>

                <button @click="show(row)" data-target="#modal-view-evaluationCriterias" data-toggle="modal"
