 ...
 */
class ClosedImprovementPlan extends Model
{
        use SoftDeletes;
    ...
    protected $appends = ['percentage_execution','quantity_progress_pending'];
