    ...
    <div class="panel-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover fix-vertical-table table-bordered">
                ...
                <tbody>
                    <tr v-for="(history, key) in dataShow.work_histories_history">
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title"><strong>Novedades</strong></h3>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
    <div class="panel-body">
            ...
            <table class="table table-hover fix-vertical-table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>@lang('Type Novelty')</th>
                        <th>@lang('Description')</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="(novelty, key) in dataShow.work_histories_novelties">
                        <td>@{{ novelty.created_at }}</td>
                        <td>@{{ novelty.user_name }}</td>
                        <td>@{{ novelty.type_novelty }}</td>
                        <td v-html="novelty.description"></td>
                    </tr>
                </tbody>
            </table>
        </div>
