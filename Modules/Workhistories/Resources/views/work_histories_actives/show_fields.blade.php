...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    ...
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title"><strong>Información general del funcionario</strong></h3>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title"><strong>Información de contacto del funcionario</strong></h3>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
    <div class="panel-body">
