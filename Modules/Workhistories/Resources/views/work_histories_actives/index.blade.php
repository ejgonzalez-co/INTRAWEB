...
@section('title', trans('Work histories').' '.trans('officers').' '.trans('actives'))
@section('section_img', 'assets/img/components/doc_funcionario.png')

@section('menu')
    @include('workhistories::layouts.menu')
@endsection

@section('content')

<crud name="work-histories-actives" 
    :resource="{default: 'work-histories-actives', get: 'get-work-histories-actives', show: 'work-histories-actives'}" 
    :exclude-export-data="['work_histories_history','documents_news','work_historie_documents','work_historie_news']"
    inline-template>
    <div>
        <!-- begin breadcrumb -->
        <ol class="breadcrumb m-b-10">
            <li class="breadcrumb-item"><a href="{!! url('/home') !!}">@lang('home')</a></li>
            <li class="breadcrumb-item active">@lang('Work histories') @lang('officers') @lang('actives')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        @if(Auth::user()->hasRole('Administrador historias laborales')) 
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('Work histories') @lang('officers') @lang('actives')'}}</h1>
        @else
        <h1 class="page-header text-center m-b-35">Vista principal para consultar historias laborales de funcionarios activos</h1>
        @endif 
        ...
        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-work-histories-actives" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('Work historie')
            </button>
        </div>
        <!-- end main buttons -->
        @endif 
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('Work histories'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
                ...
                <div id="collapseOne" class="collapse border-bottom p-l-40 p-r-40" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                                ...
                                <div class="col-md-3 row  m-b-10">
                                {!! Form::label('type_laboral', trans('Type').' laboral:', ['class' => 'col-form-label col-md-3']) !!}

                                    <select v-model="searchFields.type_laboral" class="form-control col-md-9">
                                        <option value="">Todos</option>
                                ...
                                <div class="col-md-3 row  m-b-10">
                                {!! Form::label('level_laboral', trans('Level').' laboral:', ['class' => 'col-form-label col-md-3']) !!}

                                    <select v-model="searchFields.level_laboral" class="form-control col-md-9">
                                        <option value="">Todos</option>
                                ...
                                <div class="col-md-3 row  m-b-10">
                                {!! Form::label('grade_laboral', trans('Grade').' laboral:', ['class' => 'col-form-label col-md-3']) !!}

                                    <select v-model="searchFields.grade_laboral" class="form-control col-md-9">
                                        <option value="">Todos</option>
                                ...
                                <div class="col-md-3 m-b-10">                                    
                                    {!! Form::text('denomination_laboral', null, ['v-model' => 'searchFields.denomination_laboral', 'class' => 'form-control', 'placeholder' => trans('crud.filter_by', ['name' => trans('Denomination')]) ]) !!}
                                    <small>Filtro por código o denominación</small>
                                </div>
            ...
            <div class="panel-body">
                ...
                @include('workhistories::work_histories_actives.table')
            </div>
        ...
        <!-- begin #modal-view-work-histories-actives -->
        <div class="modal fade" id="modal-view-work-histories-actives">
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('Work histories')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body" id="view-work-histories-actives">
                        <div class="row">
                            @include('workhistories::work_histories_actives.show_fields')
                        </div>
                    </div>
                    <div class="modal-footer">
                        @if(Auth::user()->hasRole('Administrador historias laborales'))
                        <button class="btn btn-warning" type="button" onclick="printContent('view-work-histories-actives');"><i class="fa fa-print mr-2"></i>@lang('print')</button>
                        @endif 
        ...
        <div class="modal fade" id="modal-view-history-work-histories-actives">
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            @include('workhistories::work_histories_actives.show_history')
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-white" data-dismiss="modal"><i class="fa fa-times mr-2"></i>@lang('crud.close')</button>
        ...
        <!-- begin #modal-form-work-histories-actives -->
        <div class="modal fade" id="modal-form-work-histories-actives">
            <div class="modal-dialog modal-xl">
                <form @submit.prevent="save()" id="form-work-histories-actives">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('Work histories')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('workhistories::work_histories_actives.fields')
                        </div>
                        <div class="modal-footer">
        ...
        <!-- end #modal-form-work-histories-actives -->
...
<script>
    ...
    $('#modal-form-work-histories-actives').on('keypress', ( e ) => {
