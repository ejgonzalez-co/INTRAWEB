...
@section('title', trans('Substitutes').' '.trans('Work histories').' '.trans('pensioners'))
...
<crud name="substitutes" :resource="{default: 'substitutes', get: 'get-substitutes'}" inline-template>
    <div>
        <!-- begin breadcrumb -->
        <ol class="breadcrumb m-b-10">
            <li class="breadcrumb-item"><a href="{!! url('/home') !!}">@lang('home')</a></li>
            <li class="breadcrumb-item active">@lang('Cuotas sustitutas')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('substitutes')'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-substitutes" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('substitute')
            </button>
        </div>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('substitutes'): ${dataList.length}` | capitalize }}</h5>
                </div>
            ...
            <div class="panel-body">
                ...
                @include('workhistories::substitutes.table')
            </div>
        ...
        <!-- begin #modal-view-substitutes -->
        <div class="modal fade" id="modal-view-substitutes">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('substitutes')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            @include('workhistories::substitutes.show_fields')
                        </div>
                    </div>
        ...
        <!-- end #modal-view-substitutes -->

        

        <!-- begin #modal-view-work-histories-actives history-->
        <div class="modal fade" id="modal-view-history-substitute">
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('Tracing') @lang('substitute')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            @include('workhistories::substitutes.show_history')
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-white" data-dismiss="modal"><i class="fa fa-times mr-2"></i>@lang('crud.close')</button>
        ...
        <!-- begin #modal-form-substitutes -->
        <div class="modal fade" id="modal-form-substitutes">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-substitutes">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('substitutes')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('workhistories::substitutes.fields')
                        </div>
                        <div class="modal-footer">
...
<script>
    ...
    $('#modal-form-substitutes').on('keypress', ( e ) => {
