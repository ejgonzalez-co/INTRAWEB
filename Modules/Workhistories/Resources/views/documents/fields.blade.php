            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::label('type_document', trans('Type Document').':', ['class' => 'col-form-label col-md-3 required']) !!}
                        ...
                        <select-check css-class="form-control" name-field="config_documents_id" reduce-label="name" name-resource="get-configuration-documents-active" :value="dataForm" :is-required="true"></select-check>
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::label('url_document', trans('Attach document').':', ['class' => 'col-form-label col-md-4 required']) !!}
                        ...
                        {!! Form::file('url_document', [ '@change' => 'inputFile($event, "url_document")']) !!}
                        </div>
                        <div class="col-md-8" v-else>
                        {!! Form::file('url_document', [ '@change' => 'inputFile($event, "url_document")', 'required' => true]) !!}
                        </div>
                    </div>
                </div>
