...
@section('title', trans('Quota parts').' '.trans('pensioners'))
...
<crud name="quota-parts-pensioners" :resource="{default: 'quota-parts-pensioners', get: 'get-quota-parts-pensioners'}" inline-template>
    <div>
        <!-- begin breadcrumb -->
        <ol class="breadcrumb m-b-10">
            <li class="breadcrumb-item"><a href="{!! url('/home') !!}">@lang('home')</a></li>
            <li class="breadcrumb-item active">@lang('Quota parts') @lang('pensioners')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('pensioners') @lang('Quota parts')'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-quota-parts-pensioners" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('Pensioner')
            </button>
        </div>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('pensioners'): ${advancedSearchFilterPaginate().length}` | capitalize }}</h5>
                </div>
      ...
      <div id="accordion" class="accordion">
            ...
            <div class="panel-body">
                ...
                @include('workhistories::quota_parts_pensioners.table')
            </div>
        ...
        <!-- begin #modal-view-quota-parts-pensioners -->
        <div class="modal fade" id="modal-view-quota-parts-pensioners">
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('Quota parts') @lang('pensioners')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            @include('workhistories::quota_parts_pensioners.show_fields')
                        </div>
                    </div>
        ...
        <!-- end #modal-view-quota-parts-pensioners -->

        <!-- begin #modal-form-quota-parts-pensioners -->
        <div class="modal fade" id="modal-form-quota-parts-pensioners">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-quota-parts-pensioners">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('form_of') @lang('Quota parts') @lang('pensioners')</h4>
                            <button @click="clearDataForm()" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body" v-if="openForm">
                            @include('workhistories::quota_parts_pensioners.fields')
                        </div>
                        <div class="modal-footer">
        ...
        <!-- end #modal-form-quota-parts-pensioners -->

               <!-- begin #modal-view-work-histories-actives history-->
               <div class="modal fade" id="modal-view-history-pensioner">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title text-white">@lang('Tracing') @lang('pensioner')</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                @include('workhistories::quota_parts_pensioners.show_history')
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-white" data-dismiss="modal"><i class="fa fa-times mr-2"></i>@lang('crud.close')</button>
...
<script>
    ...
    $('#modal-form-quota-parts-pensioners').on('keypress', ( e ) => {
