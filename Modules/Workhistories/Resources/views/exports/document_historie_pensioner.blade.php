...
<body>
	...
	<div class="center">
		...
		<p><strong>@lang('Gender'):</strong>

			@switch($workHistorie->gender)
				@case(1)
				<span>F</span>
					@break
		...
		<p><strong>@lang('Level study'):</strong> {{ $workHistorie->level_study }}</p>
		
			@if($workHistorie->level_study=='Otros')
				<span>{{ $workHistorie->level_study_other }}</span>
			@endif
