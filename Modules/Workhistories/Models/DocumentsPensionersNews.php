 ...
 */
class DocumentsPensionersNews extends Model
{
    use SoftDeletes;

    public $table = 'work_histories_p_documents_news';
    ...
    {
        return $this->belongsTo(\Modules\Workhistories\Models\WorkHistory::class, 'work_histories_p_id');
    }
    ...
    {
        return $this->belongsTo(\Modules\Workhistories\Models\WorkHistoriesDocument::class, 'documents_id');
    }
}
