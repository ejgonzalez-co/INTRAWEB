...
<crud
    ...
    :resource="{default: 'type-documentaries', get: 'get-type-documentaries'}"
    inline-template>
    <div>
        <!-- begin breadcrumb -->
        ...
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('text_title') @lang('typeDocumentaries')'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->
        <div class="m-t-20">
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-typeDocumentaries" data-toggle="modal">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @include('documentaryclassification::type_documentaries.table')
            </div>
        ...
        <!-- begin #modal-view-typeDocumentaries -->
        <div class="modal fade" id="modal-view-typeDocumentaries">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        @include('documentaryclassification::type_documentaries.show_fields')
                    </div>
        ...
        <!-- begin #modal-form-typeDocumentaries -->
        <div class="modal fade" id="modal-form-typeDocumentaries">
            <div class="modal-dialog modal-lg">
                <form @submit.prevent="save()" id="form-typeDocumentaries">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-blue">
                        ...
                        <div class="modal-body" v-if="openForm">
                            @include('documentaryclassification::type_documentaries.fields')
                        </div>
                        <div class="modal-footer">
