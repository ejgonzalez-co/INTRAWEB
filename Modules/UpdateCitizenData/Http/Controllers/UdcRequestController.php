 ...
 * @version 1.0.0
 */
class UdcRequestController extends AppBaseController {
    ...
    public function index(Request $request) {
        return view('update_citizen_data::udc_requests.index');
    }

    /**
     * Muestra la vista para el CRUD de UdcRequest para ciudadanos
     *
     * @author Erika Johana Gonzalez. - Mayo. 02 - 2021
     * @version 1.0.0
     *
     ...
     * @return Response
     */
    public function indexCitizen(Request $request) {
     ...
     */
    public function all() {
        $udc_requests = UdcRequest::with(['udcRequestHistories'])->latest()->get()->toArray();
        return $this->sendResponse($udc_requests, trans('data_obtained_successfully'));
    }
