...
class UtilController extends AppBaseController {
	...
	public function getConstants($nameConstant) {
		$dateConstant = config('documentoselectronicos.'.$nameConstant);
	...
	public static  function getNextConsecutive($formatoConsecutivo, $formatoConsecutivoPrefijo, $formatoConsecutivoValores) {
		...
		$formatoConsecutivo = str_replace("prefijo_documento", $formatoConsecutivoValores["prefijo_documento"], $formatoConsecutivo);
		...
		$formatoConsecutivoPrefijo = str_replace("prefijo_documento", $formatoConsecutivoValores["prefijo_documento"], $formatoConsecutivoPrefijo);
