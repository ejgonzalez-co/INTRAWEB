...
@section('title', 'Validar documento electrónico')
...
@section('menu')
    ...
    @else
        ...
        @include('documentoselectronicos::layouts.menu_validar_documento')
    @endif
@endsection

@section('content')
    <documentos-validator inline-template>
        <div>
            <!-- begin breadcrumb -->
            <ol class="breadcrumb m-b-10">
                <li class="breadcrumb-item"><a href="{!! url('/dashboard') !!}">@lang('home')</a></li>
                <li class="breadcrumb-item active">Validar documento electrónico</li>
            </ol>
            <!-- end breadcrumb -->

            <!-- begin page-header -->
            <h1 class="page-header text-center m-b-35">Validación de documento electrónico</h1>
            <!-- end page-header -->
            ...
            <div class="col-md-4 pl-0">
                {!! Form::text('validation_code', null, [
                    ...
                    'id' => 'validation_code',
                    '@keyup.enter' => 'validar_documento_electronico(searchFields.validation_code)',
                ]) !!}
            ...
            <div class="m-t-20">
                ...
                <button @click="validar_documento_electronico(searchFields.validation_code)" type="button" class="btn btn-primary m-b-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @include('documentoselectronicos::documentos.table_validar_documento')
                </div>
            </div>
            <!-- end panel -->

            {{-- <documentos-validator ref="corr_validator_ref"></documentos-validator> --}}
        </div>
    </documentos-validator>
@endsection
