...
/**
 * Class InvestmentTechnicalSheets
 ...
 */
class InvestmentTechnicalSheets extends Model
{
    use SoftDeletes;
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function projectAreasInfluence()
    {
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function informationTariffHarmonization()
    {
