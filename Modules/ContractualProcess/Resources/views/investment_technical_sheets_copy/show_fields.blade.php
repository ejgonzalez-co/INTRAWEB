<div class="panel" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <dd class="col-9">@{{ dataShow.dependencies? dataShow.dependencies.name: '' }}</dd>
                ...
                <table class="table table-bordered m-b-0" v-if="dataShow.information_tariff_harmonizations? dataShow.information_tariff_harmonizations.length > 0 : ''">
                    ...
                    <tbody>
                        <tr v-for="(tariffHarmonization, key) in dataShow.information_tariff_harmonizations" :key="key">
                            ...
                            <td>@{{ tariffHarmonization.unit }} <span v-html="tariffHarmonization.unit_measurement"></span></td>
                        </tr>
                    </tbody>
                </table>
            </dt>
...
<!-- Cities Id Field -->
{{-- <dt class="text-inverse col-3">@lang('Cities Id'):</dt>
<dd class="col-9">@{{ dataShow.cities_id }}</dd> --}}
...
<!-- Project Line Field -->
{{-- <dt class="text-inverse col-3">@lang('Project Line'):</dt>
<dd class="col-9">@{{ dataShow.project_line }}</dd> --}}
...
<dt class="text-inverse col-3">@lang('Project Description'):</dt>
<dd class="col-9">@{{ dataShow.project_description }}</dd>


<!-- Justification Field -->
<dt class="text-inverse col-3">@lang('Justification'):</dt>
<dd class="col-9">@{{ dataShow.justification }}</dd>


<!-- Background Field -->
<dt class="text-inverse col-3">@lang('Background'):</dt>
<dd class="col-9">@{{ dataShow.background }}</dd>


<!-- Service Coverage Field -->
<dt class="text-inverse col-3">@lang('Service Coverage'):</dt>
<dd class="col-9">@{{ dataShow.service_coverage }}</dd>


<!-- Number Inhabitants Field -->
<dt class="text-inverse col-3">@lang('Number Inhabitants'):</dt>
<dd class="col-9">@{{ dataShow.number_inhabitants }}</dd> --}}

{{-- 
<!-- Neighborhood Field -->
<dt class="text-inverse col-3">@lang('Neighborhood'):</dt>
<dd class="col-9">@{{ dataShow.neighborhood }}</dd> --}}


<!-- Commune Field -->
{{-- <dt class="text-inverse col-3">@lang('Commune'):</dt>
<dd class="col-9">@{{ dataShow.commune }}</dd> --}}


<!-- State Field -->
{{-- <dt class="text-inverse col-3">@lang('State'):</dt>
<dd class="col-9">@{{ dataShow.state }}</dd> --}}
