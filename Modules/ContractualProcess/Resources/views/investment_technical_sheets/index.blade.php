...
<crud
    ...
    :resource="{default: 'investment-technical-sheets', get: 'get-investment-technical-sheets{!! !empty($need) ? '?pc_needs_id='.$need->id : null !!}'}"
    :update-table="true"
    :init-values="{
        pc_needs_id: '{!! $need->id ?? null !!}',
    ...
    <div>
        ...
        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('Investment Technical Sheets')'}}</h1>
        <!-- end page-header -->
        ...
        <div class="m-t-20">
            ...
            <button @click="add()" type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-form-investment-technical-sheets" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('Investment Technical Sheets')
            </button>
            @endif
        </div>
        <!-- end main buttons -->
        ...
        <dynamic-modal-form
            ...
            endpoint="objectives-indicators"
            :is-update="true"
            @saved="
            if($event.isUpdate) {
                        ...
                        <div class="row">                            
                            <dynamic-list
                                ...
                                :data-list-options="[
                                    ...
                                    {label:'Actividad', name:'activity', isShow: true, selectItem: 'name'},
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::text('unit', null, ['class' => 'form-control', 'v-model' => 'scope.dataForm.unit', 'required' => true]) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"> 
                                                <div class="switcher col-md-8 m-t-5">
                                                <input type="checkbox" name="another_goal" id="another_goal" v-model="scope.dataForm.another_goal">
                                                <label for="another_goal"></label>
                                                <small></small>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    ...
    $('#modal-form-investment-technical-sheets').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
