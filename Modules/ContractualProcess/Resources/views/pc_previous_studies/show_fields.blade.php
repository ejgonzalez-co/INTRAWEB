        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.date_project }}</label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.type }}</label>
                </div>
            </div>


         
            <div class="row" v-if="dataShow.type=='Proyecto de inversión' || dataShow.type=='Funcionamiento e inversión'">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Programa</th>
                                    <th>Subprograma</th>
                                    <th>Línea de Proyecto</th>
                                </tr>
                            </thead>
                            <tbody>

                                <tr v-for="(investment_sheet, key) in dataShow.investment_sheets">
                                    <td>@{{ investment_sheet.pc_investment_technical_sheets.name_projects.name }} - @{{ investment_sheet.pc_investment_technical_sheets.description_problem_need }}</td>
                                    <td>@{{ investment_sheet.pc_investment_technical_sheets.program_name }}</td>
                                    <td>@{{ investment_sheet.pc_investment_technical_sheets.subprogram_name }}</td>
                                    <td>@{{ investment_sheet.pc_investment_technical_sheets.strategic_line_name }}</td>
                                </tr>
            ...
            <div class="col-md-6" >
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Programa: </strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.program}}</label>
                </div>
            </div>

            <div class="col-md-6" >
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Subprograma: </strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.subprogram}}</label>
                </div>
            </div>

            <div class="col-md-6" >
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Proyecto: </strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.project}}</label>
                </div>
            </div>

            <div class="col-md-6" v-if="dataShow.type=='Funcionamiento'">
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Necesidad: </strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.project_or_needs}}</label>
                </div>
            </div>

            {{-- <div class="col-md-6">
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Proceso: </strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.process}}</label>
                </div>
            </div> --}}
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.justification_tecnic_description }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.justification_tecnic_approach }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.justification_tecnic_modality }}</label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.fundaments_juridics }}</label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.imputation_budget_rubro }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.imputation_budget_interventor }}</label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.determination_object }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.determination_value? '$ '+currencyFormat(dataShow.determination_value): '' }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.determination_time_limit }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.determination_form_pay }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.obligation_principal }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-if="dataShow.obligation_principal_documentation">Si</label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-else>No</label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-if="dataShow.situation_estates_public">Si</label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-else>No</label>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.situation_estates_public_observation }}</label>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-if="dataShow.situation_estates_private">Si</label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-else>No</label>
            ...
            <div class="col-md-8">
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>@lang('Observaciones'):</strong></label>
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.situation_estates_private_observation }}</label>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row m-b-15">
                                            ...
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-if="dataShow.solution_servitude">Si</label>
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-else>No</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row m-b-15">
                                            <label class="col-form-label col-md-4 text-black-transparent-7"><strong>@lang('Observaciones'):</strong></label>
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.solution_servitude_observation }}</label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row m-b-15">
                                            ...
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-if="dataShow.solution_owner">Si</label>
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;" v-else>No</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row m-b-15">
                                            <label class="col-form-label col-md-4 text-black-transparent-7"><strong>@lang('Observaciones'):</strong></label>
                                            <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.solution_owner_observation }}</label>
                                        </div>
                                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.process_concilation }}</label>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(tipification, key) in dataShow.pc_previous_studies_tipifications">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.indication_danger_precontractual }}</label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" style="white-space: break-spaces;">@{{ dataShow.indication_danger_ejecution }}</label>
                </div>
            </div>
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title"><strong>Documentos anexos</strong></h3>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
    <div class="panel-body">
        ...
        <div class="" v-if="dataShow.pc_previous_studies_documents">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(document, key) in dataShow.pc_previous_studies_documents">
