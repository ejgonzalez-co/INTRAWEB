...
/**
 * Class DprprAlcalinidad
 * @package Modules\Leca\Models
 * @version July 15, 2022, 3:10 pm -05
 *
 ...
 */
class DprprAlcalinidad extends Model {
    use SoftDeletes;

    public $table = 'lc_dpr_pr_alcalinidad';
    ...
    public static $rules = [
        ...
        'created_at' => 'nullable',
        'updated_at' => 'nullable',
        'lc_ensayo_alcalinidad_id' => 'required'
    ];
    ...
    public function lcEnsayoAlcalinidad() {
        return $this->belongsTo(\Modules\Leca\Models\LcEnsayoAlcalinidad::class, 'lc_ensayo_alcalinidad_id');
    }
}
