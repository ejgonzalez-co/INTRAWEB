 ...
 * @property \Illuminate\Database\Eloquent\Collection $lcDprprTurbidezs
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoTurbidezs
 ...
 */
class EnsayoTurbidez extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_turbidez';
     ...
     **/
    public function lcDprprTurbidez()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprTurbidez::class, 'lc_ensayo_turbidez_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoTurbidez()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoTurbidez::class, 'lc_ensayo_turbidez_id');
    }
}