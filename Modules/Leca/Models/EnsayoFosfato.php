 ...
 * @version June 16, 2022, 5:39 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrFosfatos
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoFosfatos
 ...
 */
class EnsayoFosfato extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_fosfato';
     ...
     **/
    public function DprprFosfato()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprFosfato::class, 'lc_ensayo_fosfato_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function ObservacionesDuplicadoFosfatos()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoFosfato::class, 'lc_ensayo_fosfato_id');
    }
}