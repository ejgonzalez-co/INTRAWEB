...
/**
 * Class EnsayoCarbonoOrganico
 * @package Modules\Leca\Models
 * @version June 16, 2022, 5:48 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrCarbonoOrganicos
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoCarbonoOrganicos
 ...
 */
class EnsayoCarbonoOrganico extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_carbono_organico';
     ...
     **/
    public function DprPrCarbonoOrganico()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprCarbonoOrganico::class, 'lc_ensayo_carbono_organico_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoCarbonoOrganicos()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoCarbonoOrganico::class, 'lc_ensayo_carbono_organico_id');
    }
}