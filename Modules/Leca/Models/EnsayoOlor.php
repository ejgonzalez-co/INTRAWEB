 ...
 * @property \Illuminate\Database\Eloquent\Collection $lcDprprTurbidezOlor
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoOlor
 ...
 */
class EnsayoOlor extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_olor';
     ...
     **/
    public function lcDprPrOlor()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprOlor::class, 'lc_ensayo_olor_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoOlor()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoOlor::class, 'lc_ensayo_olor_id');
    }
}