 ...
 * @property \Illuminate\Database\Eloquent\Collection $lcDprprTurbidezConductividad
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoConductividad
 ...
 */
class EnsayoConductividad extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_conductividad';
    ...
    public static $rules = [
        ...
        'conductividad' => 'nullable|string|max:250',
     ...
     **/
    public function lcDprPrConductividad()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprConductividad::class, 'lc_ensayo_conductividad_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoConductividad()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoConductividad::class, 'lc_ensayo_conductividad_id');
    }
}