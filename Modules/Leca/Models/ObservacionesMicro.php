 ...
 */
class ObservacionesMicro extends Model {
    use SoftDeletes;
     ...
     **/
    public function lcEnsayoMicro() {
        return $this->belongsTo(\Modules\Leca\Models\EnsayoMicro::class, 'lc_ensayos_microbiologicos_id');
    }
