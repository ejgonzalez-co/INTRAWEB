 ...
 * @version August 29, 2022, 4:07 pm -05
 *
 ...
 */
class DprprEspectro extends Model {
    use SoftDeletes;

    public $table = 'lc_dpr_pr_espectro';
    ...
    public static $rules = [
        ...
        'created_at' => 'nullable',
        'updated_at' => 'nullable',
        'lc_ensayo_espectro_id' => 'required'
    ];
    ...
    public function lcEnsayoEspectro() {
        return $this->belongsTo(\Modules\leca\Models\LcEnsayoEspectro::class, 'lc_ensayo_espectro_id');
    }
}
