...
/**
 * Class DynamicPhTwoList
 * @package Modules\Leca\Models
 * @version January 5, 2022, 10:10 am -05
 *
 ...
 * @property string $t2
 */
class DynamicPhTwoList extends Model {
    use SoftDeletes;

    public $table = 'lc_dynamic_ph_two_list';
