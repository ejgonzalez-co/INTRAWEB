 ...
 * @version August 3, 2022, 9:38 am -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrDurezas
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoDurezas
 ...
 * @property string $volumen_titulacion
 * @property string $concentracion
 * @property string $cons_concentracion
 * @property string $ultimo_blanco
 */
class EnsayoDureza extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_dureza';
    ...
    public static $rules = [
        ...
        'volumen_titulacion' => 'nullable|string|max:250',
     ...
     **/
    public function lcDprPrDurezas()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprDureza::class, 'lc_ensayo_dureza_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoDurezas()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoDureza::class, 'lc_ensayo_dureza_id');
    }
}