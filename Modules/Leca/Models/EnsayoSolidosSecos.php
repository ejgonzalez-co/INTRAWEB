...
/**
 * Class EnsayoSolidosSecos
 * @package Modules\Leca\Models
 * @version December 19, 2022, 4:12 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\LcSolidosSeco $lcSolidosSecos
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrSolidosSecos
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoSolidosSecos
 * @property integer $lc_solidos_secos_id
 ...
 */
class EnsayoSolidosSecos extends Model {
    use SoftDeletes;

    public $table = 'lc_ensayo_solidos_secos';
     ...
     */
    public static $rules = [
        'lc_solidos_secos_id' => 'required|integer',
    ...
    public function lcSolidosSecos() {
        return $this->belongsTo(\Modules\Leca\Models\LcSolidosSeco::class, 'lc_solidos_secos_id');
    }
     ...
     **/
    public function lcDprPrSolidosSecos() {
        return $this->hasMany(\Modules\Leca\Models\DprPrSolidosSeco::class, 'lc_ensayo_solidos_secos_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoSolidosSecos() {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoSolidosSecos::class, 'lc_ensayo_solidos_secos_id');
    }
}
