...
/**
 * Class DprprTurbiedad
 * @package Modules\Leca\Models
 * @version August 3, 2022, 2:38 pm -05
 *
 ...
 */
class DprprTurbiedad extends Model {
    use SoftDeletes;

    public $table = 'lc_dpr_pr_turbidez';
    ...
    public static $rules = [
        ...
        'created_at' => 'nullable',
        'updated_at' => 'nullable',
        'lc_ensayo_turbidez_id' => 'required'
    ];
    ...
    public function lcEnsayoTurbidez() {
        return $this->belongsTo(\Modules\Leca\Models\EnsayoTurbiedad::class, 'lc_ensayo_turbidez_id');
    }
}
