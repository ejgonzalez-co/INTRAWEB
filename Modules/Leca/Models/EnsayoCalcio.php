 ...
 * @version August 1, 2022, 4:55 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrCalcios
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoCalcios
 ...
 */
class EnsayoCalcio extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_calcio';
     ...
     **/
    public function lcDprPrCalcios()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprCalcio::class, 'lc_ensayo_calcio_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoCalcios()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoCalcio::class, 'lc_ensayo_calcio_id');
    }
}