 ...
 * @version June 15, 2022, 5:53 pm -05
 *
 ...
 */
class DprprHierro extends Model {
    use SoftDeletes;

    public $table = 'lc_dpr_pr_hierro';
    ...
    public function lcEnsayoHierro() {
        return $this->belongsTo(\Modules\Leca\Models\LcEnsayoHierro::class, 'lc_ensayo_hierro_id');
    }
}
