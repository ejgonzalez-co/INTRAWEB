...
/**
 * Class DprPrSolidosDi
 * @package Modules\leca\Models
 * @version December 19, 2022, 10:01 am -05
 *
 ...
 */
class DprPrSolidosDi extends Model {
    use SoftDeletes;

    public $table = 'lc_dpr_pr_solidos_dis';
    ...
    public function lcEnsayoSolidosDis() {
        return $this->belongsTo(\Modules\Leca\Models\EnsayoSolidosDi::class, 'lc_ensayo_solidos_dis_id');
    }
}
