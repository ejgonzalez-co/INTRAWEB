...
/**
 * Class EnsayoNitratos
 * @package Modules\Leca\Models
 * @version June 16, 2022, 5:45 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrNitratos
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoNitratos
 ...
 */
class EnsayoNitratos extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_nitratos';
     ...
     **/
    public function DprprNitratos()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprNitratos::class, 'lc_ensayo_nitratos_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoNitratos()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoNitratos::class, 'lc_ensayo_nitratos_id');
    }
}