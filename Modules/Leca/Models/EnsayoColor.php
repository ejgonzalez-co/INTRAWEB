 ...
 * @property \Illuminate\Database\Eloquent\Collection $lcDprprTurbidezColor
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoColor
 ...
 */
class EnsayoColor extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_color';
     ...
     **/
    public function lcDprPrColor()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprColor::class, 'lc_ensayo_color_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoColor()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoColor::class, 'lc_ensayo_color_id');
    }
}