 ...
 * @version August 2, 2022, 5:40 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrCloros
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoCloros
 ...
 */
class EnsayoCloro extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_cloro';
     ...
     **/
    public function lcDprPrCloros()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprCloro::class, 'lc_ensayo_cloro_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoCloros()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoCloro::class, 'lc_ensayo_cloro_id');
    }
}