 ...
 * @version July 27, 2022, 3:41 pm -05
 *
 * @property Modules\Leca\Models\LcSampleTakingHasLcListTrial $lcSampleTakingHasLcListTrials
 * @property Modules\Leca\Models\User $users
 * @property \Illuminate\Database\Eloquent\Collection $lcDprPrAcidezs
 * @property \Illuminate\Database\Eloquent\Collection $lcObservacionesDuplicadoAcidezs
 ...
 * @property string $ph
 */
class EnsayoAcidez extends Model
{
    use SoftDeletes;

    public $table = 'lc_ensayo_acidez';
     ...
     **/
    public function lcDprPrAcidez()
    {
        return $this->hasMany(\Modules\Leca\Models\DprprAcidez::class, 'lc_ensayo_acidez_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function lcObservacionesDuplicadoAcidez()
    {
        return $this->hasMany(\Modules\Leca\Models\ObservacionesDuplicadoAcidez::class, 'lc_ensayo_acidez_id');
    }
}