...
use Modules\Leca\Models\DprprEspectro;
...
class EnsayoTrialometanosController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        return view('leca::EnsayoTrialometanos.index');
    ...
    public function getDatosBlanco()
    {
        ...
        $datosBlanco = Trialometanos::orderBy('id', 'desc')->first();
    ...
    public function getCartaDatosBlanco()
    {
        ...
        $datosBlanco = Blancos::where('lc_list_trials_id', 32)->get()->last();
    ...
    public function getCartaDatosPatron()
    {
        ...
        $datosBlanco = Patron::where('lc_list_trials_id', 32)->get()->last();
    ...
    public function store(Request $request)
    {
        $user = Auth::user();
        $Year = date("Y");
        $espectroGeneral = Trialometanos::orderBy('id', 'desc')->first();

        if ($request['tipo'] == 'Blanco') {

            $datosBlanco = Blancos::where('lc_list_trials_id', 27)->get()->last();
            ...
            if ($result1 > $result2) {
                ...
                $user = Auth::user();
                $cantidadBlancos = EnsayoEspectro::where('users_id', $user->id)->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('tipo', 'Blanco')->where('Ensayo', 'Trialometanos')->count();
                $ensayo = new EnsayoEspectro();
                ...
                $ensayo->lc_espectro_id = $espectroGeneral->id;
                ...
                $user = Auth::user();
                $cantidadBlancos = EnsayoEspectro::where('users_id', $user->id)->where('Ensayo', 'Trialometanos')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('tipo', 'Blanco')->count();
                $ensayo = new EnsayoEspectro();
                $ensayo->volumen = $request['volumen'];
                $ensayo->curva = $request['curva'];
                $ensayo->estado = 'No';
            ...
            if ($request['tipo'] == 'Patrón') {
                ...
                $datosPatron = Patron::where('lc_list_trials_id', 27)->get()->last();
                $result1 = floatval($datosPatron->lcs);
                $result2 = floatval($datosPatron->lci);
                $datosPrim = Trialometanos::where('lc_list_trials_id', 27)->get()->last();
                ...
                if ($result3 > $result2 && $result3 < $result1) {
                    ...
                    if ($request['tipo_patron'] == 'Patrón') {
                        $cantidadPatrones = EnsayoEspectro::where('users_id', $user->id)->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('tipo', 'Patrón')->where('Ensayo', 'Trialometanos')->count();
                    } else {
                        $cantidadPatrones = EnsayoEspectro::where('users_id', $user->id)->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('tipo', 'LCM')->where('Ensayo', 'Trialometanos')->count();
                    }
                    ...
                    if ($request['concentracion'] > 0) {
                        $resta = $request['concentracion'] - $espectroGeneral->valor_esperado;
                        if ($resta < 0) {
                            $resta = $resta * -1;
                        }
                        $porcentajeRecuperacion = ($resta / $espectroGeneral->valor_esperado) * 100;
                    }
                    ...
                    if ($request['tipo_patron'] == 'Patrón') {
                        $cantidadPatrones = EnsayoEspectro::where('users_id', $user->id)->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('Ensayo', 'Trialometanos')->where('tipo', 'Patrón')->count();
                    } else {
                        $cantidadPatrones = EnsayoEspectro::where('users_id', $user->id)->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('Ensayo', 'Trialometanos')->where('tipo', 'LCM')->count();
                    }
                ...
                if ($request['tipo'] == 'Ensayo') {
                    ...
                    $blanco = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Blanco')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('Ensayo', 'Trialometanos')->where('estado', 'Si')->get()->last();

                    if ($blanco) {

                        $patron = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Patrón')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('Ensayo', 'Trialometanos')->whereTime('created_at', '>=', $blanco->created_at)->where('estado', 'Si')->get()->last();

                        if ($patron) {

                            $arrayTotal['ensayo'] = EnsayoEspectro::where('users_id', $user->id)->where('Ensayo', 'Trialometanos')->where('tipo', 'Ensayo')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->whereTime('created_at', '>=', $patron->created_at)->get()->count();
                            ...
                            if ($arrayTotal['ensayo'] < $blancoGeneral->periodicidad && $arrayTotal['ensayo'] < $patronGeneral->periodicidad) {
                                ...
                                $centinela = false;
                                $verifica = Ensayo::where('lc_sample_taking_id', $request['idMuestra']['id'])->where('lc_list_trials_id', "!=", 32)->get();
                                ...
                                if ($centinela == true) {
                                    ...
                                    $history->observation = "Se realizo el analisis de la fórmula de trialometanos";
                                ...
                                $buscaEnsayo = Ensayo::where('lc_list_trials_id', 27)->where('lc_sample_taking_id', $request['idMuestra']['id'])->first();
                                $año = date('Y');
                                $array = str_split($año);
                    ...
                    if ($request['tipo'] == 'Duplicado') {
                        ...
                        // $blanco = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Blanco')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('estado', 'Si')->get()->last();

                        // if ($blanco) {

                        //     $patron = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Patrón')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->whereTime('created_at', '>=', $blanco->created_at)->where('estado', 'Si')->get()->last();

                        //     if ($patron) {

                        //         $arrayTotal['ensayo'] = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Ensayo')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->whereTime('created_at', '>=', $patron->created_at)->get()->count();
                        ...
                        if ($request['metodo'] == "Duplicado") {
                            $duplicado = EnsayoEspectro::where('users_id', $user->id)->where('tipo', 'Duplicado')->where('id_muestra', $request['idMuestra']['id_muestra'])->get()->count();
                            if ($duplicado >= 1) {
                            ...
                            if ($request['metodo'] == "Repetición") {
                                $duplicado = EnsayoEspectro::where('users_id', $user->id)->where('metodo', 'Repetición')->where('id_muestra', $request['idMuestra']['id_muestra'])->get()->count();
                                if ($duplicado >= 1) {
                                ...
                                if ($request['metodo'] == "Regla de decisión") {
                                    ...
                                    $duplicado = EnsayoEspectro::where('users_id', $user->id)->where('metodo', 'Regla de decisión')->where('Ensayo', 'Trialometanos')->where('id_muestra', $request['idMuestra']['id_muestra'])->get()->count();
                        ...
                        $history->observation = "Se realizo duplicado a la muestra de trialometanos";
                        $history->lc_sample_taking_id = $request['idMuestra']['id'];
                        $history->save();
     ...
     * @return Response
     */
    public function getAllTrialometanos()
    {
        if (!Auth::user()->hasRole('Administrador Leca')) {
            $user = Auth::user();

            $allEnsayos = EnsayoEspectro::with("lcDprPrEspectros")->where('users_id', $user->id)->where('ensayo', 'Trialometanos')->latest()->get();
        } else {
            $allEnsayos = EnsayoEspectro::with("lcDprPrEspectros")->where('ensayo', 'Trialometanos')->latest()->get();
        }
    ...
    public function getCondicionEnsayos()
    {
        ...
        $blanco = EnsayoEspectro::where('users_id', $user->id)->where('ensayo', 'Trialometanos')->where('tipo', 'Blanco')->where('estado', 'Si')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where(function ($query) {
        ...
        if ($blanco) {
            ...
            if ($blanco->aprobacion_usuario == 'Si') {
                ...
                $patron = EnsayoEspectro::where('users_id', $user->id)->where('ensayo', 'Trialometanos')->where('tipo', 'Patrón')->where('estado', 'Si')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->whereTime('created_at', '>=', $blanco->created_at)->where(function ($query) {
                    $query->where('aprobacion_usuario', 'Pendiente')->orwhere('aprobacion_usuario', 'Si');
                })->get()->last();
            } else {
                $patron = null;
    ...
    public function indexEjecutar()
    {
        ...
        $blanco = EnsayoEspectro::where('users_id', $user->id)->where('ensayo', 'Trialometanos')->where('tipo', 'Blanco')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->where('estado', 'Si')->get()->last();

        if ($blanco) {

            $patron = EnsayoEspectro::where('users_id', $user->id)->where('ensayo', 'Trialometanos')->where('tipo', 'Patrón')->whereDate('created_at', '=', Carbon::now()->format('Y-m-d'))->whereTime('created_at', '>=', $blanco->created_at)->where('estado', 'Si')->get()->last();
            ...
            if ($patron) {
                ...
                if ($arrayTotal['ensayo'] <= $blancoGeneral->periodicidad && $arrayTotal['ensayo'] <= $patronGeneral->periodicidad) {
                    ...
                    return view('leca::EnsayoTrialometanos.ejecutar');
    ...
    public function allMuestras()
    {
        ...
        $ensayo = Ensayo::where('lc_list_trials_id', 32)->where('estado', 'Pendiente')->get();
    ...
    public function storeTendido(Request $request)
    {
        ...
        $muestras = TendidoMuestras::where('users_id', $user->id)->where('lc_list_trials_id', 32)->where('estado', 'Activo')->get();
    ...
    public function allTendido()
    {
        ...
        $user = Auth::user();
        $arrayTotal = [];
        $tendido = TendidoMuestras::where('users_id', $user->id)->where('lc_list_trials_id', 32)->where('estado', 'Activo')->get();
    ...
    public function allTendidoFinalizado()
    {
        ...
        $user = Auth::user();
        $arrayTotal = [];
        $tendido = TendidoMuestras::where('users_id', $user->id)->where('lc_list_trials_id', 32)->whereDate('fecha_finalizado', '=', Carbon::now()->format('Y-m-d'))->where('estado', 'Finalizado')->get();
    ...
    public function consultaDecimalesBlanco()
    {
        ...
        $user = Auth::user();
        $blancoDecimales = Blancos::where('lc_list_trials_id', 32)->get()->last();
    ...
    public function consultaDecimalesPatron()
    {
        ...
        $user = Auth::user();
        $patronDecimales = Patron::where('lc_list_trials_id', 32)->get()->last();
    ...
    public function consultaDecimalesEnsayo()
    {
        ...
        $user = Auth::user();
        $arrayTotal = [];
        $ensayoDecimales = Trialometanos::where('lc_list_trials_id', 32)->get()->last();
    ...
    public function storeDpr(Request $request)
    {
        ...
        $dpr->lc_ensayo_espectro_id = $request['id_ensayo'];
    ...
    public function getDatosPr($id)
    {
        ...
        $dpr = DprprEspectro::where('id_ensayo', $id)->where('tipo', 'Porcentaje de recuperacion')->where('ensayo', 'Trialometanos')->get();
    ...
    public function getDatosRelativa($id)
    {
        ...
        $dpr = DprprEspectro::where('id_ensayo', $id)->where('tipo', 'Diferencia porcentual relativa')->where('ensayo', 'Trialometanos')->get();
    ...
    public function getAllShowEnsayo(Request $request)
    {
        ...
        $ensayo = EnsayoEspectro::with(['lcDprPrEspectros', 'ObservacionesDuplicadoEspectros'])->where('id_muestra', $idEnsayo)->get();
        $ensayo->toArray();
    ...
    public function getAllShowPatronBlanco(Request $request)
    {
        ...
        $ensayoA = EnsayoEspectro::where('id', $request['id'])->where('ensayo', 'Trialometanos')->get()->last();

        $date = Carbon::parse($ensayoA->created_at)->format('Y-m-d');
        $time = Carbon::parse($ensayoA->created_at)->toTimeString();

        $blanco = EnsayoEspectro::whereDate('created_at', '<=', $date)->whereTime('created_at', '<', $time)->where('ensayo', 'Trialometanos')->where('tipo', 'Blanco')->where('estado', 'Si')->get()->last();
        $patron = EnsayoEspectro::whereDate('created_at', '<=', $date)->whereTime('created_at', '<', $time)->where('ensayo', 'Trialometanos')->where('tipo', 'Patrón')->where('estado', 'Si')->get()->last();
    ...
    public function exporta(Request $request)
    {
        ...
        $datosPrimarios = Trialometanos::whereDate('created_at', '<=', $input[0]['created_at'])->get()->last();
        ...
        $spreadsheet->getActiveSheet()->setCellValue('D19', $datosPrimarios->valor_esperado ?? 'N/A');
        ...
        $criticalEquip = CriticalEquipment::where('lc_list_trials_id', 32)->latest()->take(4)->get();
        ...
        for ($i = 25; $i < $numTotal; $i++) {
            ...
            if ($input[$cont]['tipo'] == 'Duplicado') {
                ...
                $dprpr = DprprEspectro::where('lc_ensayo_espectro_id', $input[$cont]['id'])->get();
    ...
    public function getEnsayoPrincipal($id)
    {
        ...
        $ensayo = EnsayoEspectro::where('id_muestra', $id)->where('ensayo', 'Trialometanos')->where('tipo', 'Ensayo')->first();
    ...
    public function estadoEnsayo(Request $request)
    {
        ...
        $ensayo = EnsayoEspectro::find($request['id']);
    ...
    public function getGrafico(Request $request)
    {
        ...
        $data[] = ["range" => "BK!B7", "values" => [["Trialometanos"]]];
        $data[] = ["range" => "STD!E7", "values" => [["Trialometanos"]]];
        $data[] = ["range" => "%S std 0,20!E7", "values" => [["Trialometanos"]]];
        $data[] = ["range" => "LCM!E7", "values" => [["Trialometanos"]]];
        $data[] = ["range" => "DPR!B7", "values" => [["Trialometanos"]]];
        $data[] = ["range" => "Adicionado!E7", "values" => [["Trialometanos"]]];
        ...
        $blanco = Blancos::where('lc_list_trials_id', 27)->get()->last();
        ...
        $ensayo = Trialometanos::orderBy('id', 'desc')->first();
        ...
        $patron = Patron::where('lc_list_trials_id', 27)->get()->last();
                ...
                if($item["tipo"]=="Patrón") {
                    ...
                    if($item["tipo"]=="LCM") {
                        ...
                        if($item["tipo"]=="Duplicado") {
                            ...
                            $contDpr++;
                            if($contDpr<=31){
                                if($item["lc_dpr_pr_espectros"]){
                                    foreach ($item["lc_dpr_pr_espectros"] as $value){
        ...
        $fileIdCopy = $e->editFileExcelBatch("1uyyhyJaHAyys46Rjx_Fwon6k2NCTG5eUkzzC2zkZQYk", $data, true);

        $e->downloadFileGoogleDrive($fileIdCopy, "Ensayo Trialometanos", "excel", true);
    }
}