        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <ul>
                            <li v-for="(role, key) in dataShow.roles" :key="key" v-if="role.name == 'Toma de Muestra' || role.name == 'Recepcionista' || role.name == 'Personal de Apoyo' || role.name == 'Administrador Leca' || role.name == 'Analista fisicoquímico' || role.name == 'Analista microbiológico'">
                                @{{ role.name }}
                            </li>
                        </ul>
                    </div>
