...
@section('title', 'Ejecución ensayo Fosfato')

@section('section_img', '/assets/img/components/doc_funcionario.png')

@section('menu')
    @include('leca::layouts.menu_fosfato_ejecucion')
@endsection

@section('content')


    <aluminio-ensayo titulo="Fosfatos" name-formulario="fosfato"></aluminio-ensayo>
