@component('mail::layout')
    ...
    Un cordial saludo, los datos de la empresa {{ $data['name'] }} han sido creados en el aplicativo de gestión de estudios del laboratorio LECA de las empresas públicas de Armenia. Sus datos de ingreso son
