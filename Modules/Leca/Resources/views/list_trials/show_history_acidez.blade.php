...
<div class="table-responsive">
    ...
    <tr v-for="history in dataShow.lc_acidez">
        ...
        <td style="padding: 15px">@{{ history.nombre_calidad }}</td>
        <td style="padding: 15px">@{{ history.valor_esperado }}</td>
        <td style="padding: 15px">@{{ history.factor }}</td>
