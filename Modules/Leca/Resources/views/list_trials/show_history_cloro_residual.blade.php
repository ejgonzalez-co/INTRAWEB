...
<div class="table-responsive">
    ...
    <tr>
        ...
        <th>Año</th>
        <th>Mes</th>
        <th>Concentración FAS gastado</th>
        <th>Nombre patrón</th>
        <th>Valor esperado</th>
        <th>Factor/Cálculo</th>
        <th>Límite de cuantificación</th>
        <th>Cloro residual desde</th>
        <th>Cloro residual hasta</th>
        <th>Observación</th>
    ...
    <tr v-for="history in dataShow.lc_cloro_residual">
        ...
        <td style="padding: 15px">@{{ history.concentracion_fas }}</td>
        ...
        <td style="padding: 15px">@{{ history.cloro_residual_desde }}</td>
        <td style="padding: 15px">@{{ history.cloro_residual_hasta }}</td>
