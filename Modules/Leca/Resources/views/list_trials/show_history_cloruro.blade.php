...
<div class="table-responsive">
    ...
    <tr>
        ...
        <th>Año</th>
        <th>Mes</th>
        <th>Concentración AgNO<sub>3</sub></th>
        <th>Nombre patrón</th>
    ...
    <tr v-for="history in dataShow.lc_cloruro">
        ...
        <td style="padding: 15px">@{{ history.concentracion_agno }}</td>
        ...
        <td style="padding: 15px">@{{ history.cloruros }}</td>
