        ...
        <table style="margin: 0 auto;" cellspacing="2" cellpadding="2" border="1">
            <tr>
                <th align="center" colspan="1" rowspan="5"><img src="{{ asset('assets/img/default/icon_epa.png') }}"
                        width="100" /></th>
                <th colspan="3" rowspan="5">Registro de datos primarios Ensayo Cloro Residual
        ...
        <table class="tableTH" cellspacing="2" cellpadding="2" border="1" style="margin: 0 auto;">
            <tr>
                <th>
                    <i>mg </i>CI/L =
                    <div class="fraction">
                        <span class="fup">(A * N * 35450)</span>
                        <span class="bar">/</span>
                        <span class="fdn">V</span>
                    </div>
                    <p>A = mL de la solución de FAS gastado en la valoración</p>
                    <p>V = mL muestra tomada</p>
                    <p>N = normalidad de FAS</p>
                </th>
            </tr>
        </table>
    </div>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <!-- Pendiente -->
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-3">@lang('limit_cuantifi'):</label>
                    <div class="col-md-9">
...
<div class="panel" data-sortable-id="ui-general-1">
    <div class="panel-body">
        <!-- begin panel-heading -->
        <div class="panel-heading ui-sortable-handle">
            <h4 class="panel-title"><strong>Concentración FAS</strong></h4>
        </div>
        <div class="row">
            <div class="col-md-6">
                <!-- Pendiente -->
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-3">@lang('concentration_FAS'):</label>
                    <div class="col-md-9">
                        <dd class="form-control">@{{ dataShow.concentracion_fas }}.</dd>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <dd class="form-control">@{{ dataShow.factor_calculo }}.</dd>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="tableTH" width="350" height="50" cellspacing="2" cellpadding="2" border="1"
            ...
            <tr>
                <th>Convenciones
                    ...
                    <p>MFD = Concentración del duplicado (1)</p>
                </th>
            </tr>
        </table>
    </div>
   ...
   <div class="panel-body">
       ...
       <div class="row">
           <div class="col-md-6">
               <!-- Pendiente -->
               <div class="form-group row m-b-15">
                   <label class="col-form-label col-md-3">@lang('residual_chlorine_from'):</label>
                   <div class="col-md-9">
                       <dd class="form-control">@{{ dataShow.cloro_residual_desde }}.</dd>
                   </div>
               </div>
           </div>
           <div class="col-md-6">
               <!-- Pendiente -->
               <div class="form-group row m-b-15">
                   <label class="col-form-label col-md-3">@lang('residual_chlorine_to'):</label>
                   <div class="col-md-9">
                       <dd class="form-control">@{{ dataShow.cloro_residual_hasta }}.</dd>
                   </div>
               </div>
           </div>
       </div>
