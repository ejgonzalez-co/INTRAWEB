        ...
        <table style="margin: 0 auto;" cellspacing="2" cellpadding="2" border="1">
            <tr>
                <th align="center" colspan="1" rowspan="5"><img src="{{ asset('assets/img/default/icon_epa.png') }}"
                        width="100" /></th>
                <th colspan="3" rowspan="5">Registro de datos primarios Ensayo Acidez
                </th>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <dd>@{{ dataShow.documento_referencia }}.</dd>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
...
<div class="panel" data-sortable-id="ui-general-1">
    <div class="panel-body">
        ...
        <table class="tableTH" cellspacing="2" cellpadding="2" border="1" style="margin: 0 auto;">
            <tr>
                <th>
                    <i>mg/L </i>de acidez =
                    <div class="fraction">
                        <span class="fup">(Volumen gastado)(A)(50000)</span>
                        <span class="bar">/</span>
        ...
        <table class="tableTH" cellspacing="2" cellpadding="2" border="1" style="margin: 0 auto;">
            <tr>
                <th>Donde
                    <p>A = Concentración del hidróxido de sodio (NaOH)</p>
...
<div class="panel" data-sortable-id="ui-general-1">
    <div class="panel-body">
        <!-- begin panel-heading -->
        <div class="panel-heading ui-sortable-handle">
            <h4 class="panel-title"><strong>Control de calidad</strong></h4>
        </div>
        <div class="row">
            <div class="col-md-6">
                <!-- Pendiente -->
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        <dd class="form-control">@{{ dataShow.nombre_calidad }}.</dd>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <!-- Pendiente -->
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-3">@lang('concentration_neq'):</label>
                    <div class="col-md-9">
                        <dd class="form-control">@{{ dataShow.concentracion }}.</dd>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
               <!-- Pendiente -->
               <div class="form-group row m-b-15">
                   <label class="col-form-label col-md-3">@lang('Factor'):</label>
                   <div class="col-md-9">
                       <dd class="form-control">@{{ dataShow.factor }}.</dd>
                   </div>
               </div>
           </div>
        </div>
