@component('mail::layout')
   ...
   <a href="{{ config('app.url') }}/correspondence/external-receiveds?qder={{ !empty($data['id_encrypted']) ? $data['id_encrypted'] : '' }}" title="Gestionar solicitud">Gestionar solicitud</a>
