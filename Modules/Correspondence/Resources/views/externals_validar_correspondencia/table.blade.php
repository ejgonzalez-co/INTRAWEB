<div class="table-responsive">
    <table-component
        ...
        <table-column show="type_document" label="@lang('Type')"></table-column>
        ...
        <table-column show="citizen_name" label="Ciudadano"></table-column>
        ...
        <table-column label="@lang('crud.action')" :sortable="false" :filterable="false">
            <template slot-scope="row">
                <button  @click="validar_documento_correspondencia_enviada()" class="btn btn-white btn-icon btn-md" data-toggle="tooltip" data-placement="top" title="validar documento">
