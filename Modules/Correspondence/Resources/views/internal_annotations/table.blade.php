...
<article  v-for="(anotacion,key) in dataList">
    <div class="inner">
        <span class="date">
            <span class="day"> @{{ anotacion.date_format_day }}</span>
            <span class="month"> @{{ anotacion.date_format_month }}</span>
            <span class="year"> @{{ anotacion.date_format_year }}</span>
          </span>
        ...
        <p>
          <strong>Fecha y hora:</strong> @{{ anotacion.date_format_day }} de @{{ anotacion.date_format_month_completo }} de @{{ anotacion.date_format_year }} @{{ anotacion.date_format_hour }}<br>
          <strong>Anotación:</strong>
          <p style="white-space: break-spaces;" v-html='anotacion.content'></p>
...
{{-- <div class="table-responsive" v-show="false">
    <table-component
        id="internalAnnotations-table"
        :data="advancedSearchFilterPaginate()"
        sort-by="internalAnnotations"
        sort-order="asc"
