<div class="table-responsive">
    <table-component
        ...
        >
            ...
            <table-column show="id" label="@lang('ID')">
            ...
            <table-column show="dependencia_funcionario" label="@lang('Dependencia')">
                <template slot-scope="row"><div>@{{ row.dependencia_funcionario }}</div></template>
            </table-column>
