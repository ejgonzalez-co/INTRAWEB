...
@section('menu')
    ...
    @else
        ...
        @include('correspondence::layouts.menu_validar_internal')
    @endif
@endsection
    ...
    <correspondence-validator inline-template>
        <div>
            ...
            <ol class="breadcrumb m-b-10">
                ...
                <li class="breadcrumb-item active">Validar correspondencia interna</li>
            </ol>
            <!-- end breadcrumb -->

            <!-- begin page-header -->
            <h1 class="page-header text-center m-b-35">Validación de correspondencia interna</h1>
            <!-- end page-header -->
            <div class="mb-2" style="color: inherit; background-color: #eee; border-radius: 0.5rem; !important; padding: 1rem;">
                ...
                <ol>
                    ...
                    <li>Haga clic el el botón: Validar correspondencia.</li>
            ...
            <div class="col-md-4 pl-0">
                {!! Form::text('validation_code', null, [
                    ...
                    'id' => 'validation_code',
                    '@keyup.enter' => 'validar_correspondencia_interna(searchFields.validation_code)',
                ]) !!}
            ...
            <div class="m-t-20">
                ...
                <button @click="validar_correspondencia_interna(searchFields.validation_code)" type="button" class="btn btn-primary m-b-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @include('correspondence::internals_validar_correspondencia.table')
                </div>
            </div>
            <!-- end panel -->

            {{-- <correspondence-validator ref="corr_validator_ref"></correspondence-validator> --}}
        </div>
