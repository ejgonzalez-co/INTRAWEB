...
<!-- Template Field -->
<div class="form-group row m-b-15">
    {!! Form::label('template', trans('Template').':', ['class' => 'col-form-label col-md-3']) !!}
    <div class="col-md-9">
        ...
        <template #fields="scope">
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-9">
                    ...
                    <option value="#ciudadano_documento">#ciudadano_documento - Documento Destinatario ciudadano del documento</option>
                    <option value="#ciudadano_email">#ciudadano_email - Email ciudadano del documento</option>
                    <option value="#ciudadano">#ciudadano - Nombre Destinatario ciudadano del documento</option>
                    ...
                    <option value="#respuesta_pqr">#respuesta_pqr - Consecutivo del pqr al que da respuesta</option>
