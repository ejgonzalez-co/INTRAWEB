        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8">@{{ dataShow.dependencia_remitente ? dataShow.dependencia_remitente : 'N/A' }} </label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8">@{{ dataShow.funcionario_remitente ? dataShow.funcionario_remitente : 'N/A' }}</label>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.enviadoa">@{{ dataShow.enviadoa }}</label>
                    <label class="col-form-label col-md-8" v-else>@{{ dataShow.nombre_ciudadano ? dataShow.nombre_ciudadano : 'N/A' }}</label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.documento_ciudadano">@{{ dataShow.documento_ciudadano ? dataShow.documento_ciudadano : 'N/A' }}</label>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.email_ciudadano">@{{ dataShow.email_ciudadano ? dataShow.email_ciudadano : 'N/A' }}</label>
                    <label class="col-form-label col-md-8" v-else>N/A</label>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.telefono">@{{ dataShow.telefono ? dataShow.telefono : ' N/A' }}</label>
                    <label class="col-form-label col-md-8" v-else>N/A</label>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.depto">@{{ dataShow.depto ? dataShow.depto : 'N/A' }}</label>
                    <label class="col-form-label col-md-8" v-else>N/A</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <label class="col-form-label col-md-8" v-if="dataShow.ciudad">@{{ dataShow.ciudad ? dataShow.ciudad : 'N/A' }}</label>
                    <label class="col-form-label col-md-8" v-else>N/A</label>
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
    <div class="panel-heading ui-sortable-handle">
        <h4 class="panel-title"><strong>Datos del asociado</strong></h4>
    </div>
    <!-- end panel-heading -->
    <!-- begin panel-body -->
    <div class="panel-body">
        <div class="row">
            <!-- Estado Field -->
            <label class="col-form-label col-md-2 text-black-transparent-7"><strong>Correspondencia asociada:
                        </strong></label>
            <dd class="col-sm-3 col-md-3 col-lg-3">@{{ dataShow.rconsecutivo ?? 'NA'}}.</dd>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    ...
                    <a :href="dataShow.plantilla" Target="_blank" class="col-form-label col-md-8" v-if="dataShow.plantilla">Ver plantilla</a>
                    <label class="col-form-label col-md-8" v-else>/N/A</label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-4 text-black-transparent-7"><strong>Número de Guía:
                        </strong></label>
                    <label class="col-form-label col-md-8" v-if="dataShow.guia">@{{ dataShow.guia }}</label>
                    <label class="col-form-label col-md-8" v-else>N/A</label>
                </div>
            </div>
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
            ...
            <annotation-and-read :leido="dataShow.leido" campo="id_externa" route-annotation="get-annotations" table-annotations="externa_anotacion" :id-correspondence="dataShow.cf_id"></annotation-and-read>
