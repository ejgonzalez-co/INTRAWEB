            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        ...
                        <select-check css-class="form-control" name-field="classification_production_office" reduce-label="nombre" name-resource="/intranet/get-dependencies" :is-required="true" :value="dataForm" :enable-search="true" :ids-to-empty="['classification_serie','classification_subserie']"></select-check>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        ...
                        <select-check css-class="form-control" name-field="classification_serie" reduce-label="name" reduce-key="id_series_subseries" :is-required="true" :name-resource="'/documentary-classification/get-inventory-documentals-serie-dependency/'+ dataForm.classification_production_office"
                        :value="dataForm" :enable-search="true" :key="dataForm.classification_production_office"></select-check>
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-9">
                        ...
                        <select-check css-class="form-control" name-field="classification_subserie" reduce-label="name_subserie" :name-resource="'/documentary-classification/get-subseries-clasificacion?serie='+dataForm.classification_serie" :is-required="false" :value="dataForm" :key="dataForm.classification_serie" :enable-search="true"></select-check>
