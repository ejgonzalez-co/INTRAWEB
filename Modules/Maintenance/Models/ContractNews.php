...
class ContractNews extends Model {
     ...
     **/
    public function rubrosItems() {
        return $this->belongsTo(\Modules\Maintenance\Models\AdministrationCostItem::class, 'mant_contract_news_id')->latest();
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function addingCostItem() {
        return $this->hasMany(\Modules\Maintenance\Models\AddingCostItem::class, 'mant_contract_news_id');
    }
