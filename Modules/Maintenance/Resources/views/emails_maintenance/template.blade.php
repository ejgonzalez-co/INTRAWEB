		...
		<div class="row">
			<table>
				<tr style="background-color: #6fb154; color: white;">
					<td><img style="width: 120px;float: left;padding-right: 20px;" src="https://app.intraepa.gov.co/assets/img/logo_epa.png"><h3> Mantenimiento de activos - {{$data["title"]}}</h3></td>
				</tr>
				<tr>
					<td colspan="100%">
                        <p>
						...
						<p>
							<br><br>
							Para consultar esta información por favor ingrese con su usuario y contraseña a la https://intraepa.gov.co/ 
						</p>
                    </td>
				</tr>
