...
@section('content')
    ...
    <crud name="butgetExecutions"
        :resource="{default: 'butget-executions', get: 'get-butget-executions-provider?mpc={!! $mpc ?? null !!}'}"
        :init-values="{provider_id: '{!! $mpc ?? null !!}'}"
        ...
        <div>
            ...
            <!-- begin page-header -->
            <h1 class="page-header text-center m-b-35">Vista principal para la consulta de la ejecución del contrato proveedor
                </h1>
            <!-- end page-header -->
            ...
            <div class="m-t-20">
                <div class="m-4">
                    <a class="btn btn-primary m-b-10 " href="budget-provider"><span><i
                                class="fa fa-arrow-left mr-3"></i>Atras</span></a>
                </div>
            </div>
            <!-- end main buttons -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @include('maintenance::execution_budget_look.table')
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content border-0">
                        ...
                        <div class="modal-body" id="contentDetalles">
                            @include('maintenance::execution_budget_look.show_fields')
                        </div>
