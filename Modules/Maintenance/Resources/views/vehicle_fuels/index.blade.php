...
<crud
    name="vehicle-fuels"
    :resource="{default: 'vehicle-fuels', get: 'get-vehicle-fuels'}"
    inline-template
    :crud-avanzado="true"
    ref="crud">
    <div>
        ...
        <div class="m-t-20">
            ...
            <button  @click="callFunctionComponent('loadVehicleFuel', 'loadVehicle');" type="button" data-backdrop="static"  class="btn btn-primary m-b-10" data-toggle="modal">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') combustible
            </button>
            @endif
            {{-- <button  type="button" class="btn btn-primary m-b-10" data-backdrop="static" data-target="#modal-historical-vehicles" data-toggle="modal">
                <i class="fas fa-history"></i>  Histórico
            </button> --}}
            <a href="register-all-vehicle-fuel" class="btn btn-primary m-b-10"><i class="fas fa-gas-pump"></i> Todos los registros</a>

            <a href="historical-import-vehicle-fuel" class="btn btn-primary m-b-10"><i class="fas fa-history"></i>  Histórico</a>
