...
@section('title', trans('oilHistories'))
...
<crud
    name="oilHistories"
    :resource="{default: 'oil-histories', get: 'get-oil-histories'}"
    inline-template>
    <div>
        <!-- begin breadcrumb -->
        <ol class="breadcrumb m-b-10">
            <li class="breadcrumb-item"><a href="{!! url('/home') !!}">@lang('home')</a></li>
            <li class="breadcrumb-item active">@lang('oilHistories')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('oilHistories')'}}</h1>
        <!-- end page-header -->
        ...
        <div class="m-t-20">
            ...
            <div class="m-4">
                <a class="btn btn-primary m-b-10 " href="{{ route('oil.index') }}"><span><i
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('oilHistories'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
            ...
            <div class="panel-body">
                ...
                @include('maintenance::oil_histories.table')
            </div>
...
<script>
    ...
    $('#modal-form-oilHistories').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
