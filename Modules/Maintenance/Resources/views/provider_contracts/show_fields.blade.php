...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        <div class="form-group row m-b-15">
            ...
            <dt class="text-inverse text-left col-3 pb-2">Vigencia futura:</dt>
            <dd class="col-3">@{{ dataShow . future_validity  }}.</dd>

            <!-- Document Type Field -->
            <dt class="text-inverse text-left col-3 pb-2">Pago anticipado o anticipo:</dt>
            <dd class="col-3">@{{ dataShow . advance_payment}}.</dd>

            <!-- Identification Field -->
            <dt v-if="dataShow . advance_payment == 'Si'" class="text-inverse text-left col-3 pb-2">Valor anticipo:</dt>
            <dd v-if="dataShow . advance_payment == 'Si'"  class="col-3">$ @{{  currencyFormat(dataShow . advance_value)  }}.</dd>
...
<div v-if="dataShow.mant_history_budget_assignation?.length" class="panel col-md-12" data-sortable-id="ui-general-1">
            ...
            <div class="row" style="margin: auto;">
                <div class="table-responsive">
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(document, key) in dataShow.mant_history_budget_assignation " v-if="document.novelty_type=='Asignación presupuestal'">
                                <td>@{{ document . name }}</td>
                                <td>@{{ document . created_at }}</td>
                                <td>@{{ document . name_user }}</td>
                                <td>@{{ document . observation }}</td>
    ...
    <div v-for="(document, key) in dataShow.mant_budget_assignation">
        ...
        <div v-if="document.mant_history_administration_cost_items != null" class="panel col-md-12"
            ...
            <!-- begin panel-heading -->
            <div class="panel-heading ui-sortable-handle">
                <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Historial de rubros de presupuestos</strong>
                </h3>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Historial de novedades</strong>
        </h3>
    </div>
    <!-- end panel-heading -->
    ...
    <div class="panel-body">
        ...
        <div class="panel col-md-12" data-sortable-id="ui-general-1">
            <!-- begin panel-heading -->
            <div class="panel-heading ui-sortable-handle">
                <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Novedad de adiciones</strong>
                </h3>
            </div>
            <!-- end panel-heading -->
                            ...
                            <table class="table table-responsive table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Valor CDP</th>
                                        <th>Fecha CDP</th>
                                        <th>Fecha del modificatorio</th>
                                        <th>Observación</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(document, key) in dataShow.mant_history_budget_assignation" v-if="document.novelty_type=='Adición al contrato'">
                                        <td>@{{ document . consecutive }}</td>
                                        <td>@{{ document . number_cdp }}</td>
                                        <td>$@{{ currencyFormat(document . value_cdp) }}</td>
                                        <td>@{{ document . created_at }}</td>
        ...
        <div class="panel col-md-12" data-sortable-id="ui-general-1">
            <!-- begin panel-heading -->
            <div class="panel-heading ui-sortable-handle">
                <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Novedad de prorroga</strong>
                </h3>
            </div>
            <!-- end panel-heading -->
                    ...
                    <div class="row" style="margin: auto;">
                        <div class="table-responsive">
                            <table class="table table-responsive table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="(document, key) in dataShow.mant_history_budget_assignation" v-if="document.novelty_type=='Prórroga'">
                                        <td>@{{ document . consecutive }}</td>
                                        <td>@{{ document . 	time_extension }}</td>
                                        <td>@{{document . date_contract_term }}</td>
                                        <td>@{{ document . 	date_modification }}</td>
                                        <td>@{{ document . observation }}</td>
        ...
        <div class="panel col-md-12" data-sortable-id="ui-general-1">
            <!-- begin panel-heading -->
            <div class="panel-heading ui-sortable-handle">
                <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Novedad de suspensiónes</strong>
                </h3>
            </div>
            <!-- end panel-heading -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive table-bordered">
                                <thead>
                                    <tr>
                                        <th>Consecutivo</th>
                                        <th>Tipo de susspensión</th>
                                        <th>Fecha acta de suspensión</th>
                                        <th>Tiempo de suspensión</th>
                                        <th>Fecha de inicio de suspensión</th>
                                        <th>Fecha fin sispensión</th>
                                ...
                                <tbody>
                                    <tr v-for="(document, key) in dataShow.mant_history_budget_assignation" v-if="document.novelty_type=='Suspensión'">
                                        <td>@{{ document . consecutive }}</td>
                                        <td>@{{ document . 	type_suspension }}</td>
                                        <td>@{{ document . 	date_act_suspension }}</td>
                                        <td>@{{ document . 	time_suspension }}</td>
                                        <td>@{{ document . 	date_start_suspension }}</td>
                                        <td>@{{ document . date_end_suspension }}</td>
                                        <td>@{{ document . date_contract_term }}</td>
                                        <td>@{{ document . observation }}</td>
        ...
        <div class="panel col-md-12" data-sortable-id="ui-general-1">
            <!-- begin panel-heading -->
            <div class="panel-heading ui-sortable-handle">
                <h3 class="panel-title" style="text-align: center; font-size: 13px;"><strong>Novedad de Reinicio</strong>
                </h3>
            </div>
            <!-- end panel-heading -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive table-bordered">
                                <thead>
                                    <tr>
                                        <th>Consecutivo</th>
                                        <th>Fecha de la última suspensión</th>
                                        <th>Fecha del reinicio</th>
                                        <th>Fecha de terminación del contrato</th>
                                        <th>Observación</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(document, key) in dataShow.mant_history_budget_assignation" v-if="document.novelty_type=='Reinicio'">
                                        <td>@{{ document . consecutive }}</td>
                                        <td>@{{ document . 	date_last_suspension }}</td>
                                        <td>@{{ document . date_last_suspension }}</td>
                                        <td>@{{ document . date_contract_term }}</td>
                                        <td>@{{ document . observation }}</td>
