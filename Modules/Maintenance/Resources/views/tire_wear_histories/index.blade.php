...
<crud
    name="tireWearHistories"
    :resource="{default: 'tire-wear-histories', get: 'get-tire-wear-histories?tire={!! $tire ?? null !!}'}"
    :init-values="{tire: '{!! $tire ?? null !!}'}"
    ...
    <div>
        ...
        <ol class="breadcrumb m-b-10">
            ...
            <li class="breadcrumb-item active">@lang('tireWearHistories')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') el historial de desgaste'}}</h1>
        <!-- end page-header -->

        <!-- begin main buttons -->


        <a :href="'tire-wears?individual_tire_id={!! $tire !!}'" class="btn btn-primary m-b-10"><i class="fa fa-arrow-left mr-3"></i>Atrás</a>
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers')l historial del desgaste de la llanta: ${dataPaginator.total}` | capitalize }}</h5>
                </div>
            ...
            <div class="panel-body">
                ...
                @include('maintenance::tire_wear_histories.table')
            </div>
        ...
        <!-- begin #modal-view-tireWearHistories -->
        <div class="modal fade" id="modal-view-tireWearHistories">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('tireWearHistories')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body">
                        @include('maintenance::tire_wear_histories.show_fields')
                    </div>
        ...
        <!-- end #modal-view-tireWearHistories -->

        <!-- begin #modal-form-tireWearHistories -->
...
<script>
    ...
    $('#modal-form-tireWearHistories').on('keypress', ':input:not(textarea):not([type=submit])', function (e) {
