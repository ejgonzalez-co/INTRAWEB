...
<crud
    name="contractNews"
    :resource="{default: 'contract-news', edit: 'edit-contract-news', get: 'get-contract-news?mpc={!! $mpc ?? null !!}', delete:'elimina/{{ $mpc}}' }"
    :init-values="{
        mant_provider_contract_id: '{!! $providerContract->id ?? null !!}', providerContract:{{ $providerContract ?? null }}, rubrosItems:{{ $rubrosItems ?? null }}
         }"  
    inline-template>
    <div>
        <!-- begin breadcrumb -->
