...
<div v-if="dataForm.novelty_type == 'Adición al contrato'" class="panel" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        ...
        <dynamic-table v-if="isUpdate" :data-list.sync="dataForm.adding_cost_item" update="true"
            :data-list-options="[
                {label:'Cód. del rubro', name:'code_cost', isShow: true},
                {label:'Nombre del rubro', name:'name', isShow: true},
                {label:'Cód. centro de costo', name:'cost_center', isShow: true},
                {label:'Nombre del centro de costo', name:'cost_center_name', isShow: true},
                {label:'Valor inicial del rubro', name:'value_item_old', isShow: true},
                {label:'Valor de la adición', name:'value_eddition', isShow: true},
                {label:'Valor total del rubro', name:'total_eddition', isShow: true},
            ]"
            class-container="" class-table="table table-bordered" :is-remove="false">
        </dynamic-table>

        <dynamic-table v-else :data-list.sync="dataForm.rubrosItems"
            :data-list-options="[
                {label:'Cód. del rubro', name:'code_cost', isShow: true},
                {label:'Nombre del rubro', name:'name', isShow: true},
                {label:'Cód. centro de costo', name:'cost_center', isShow: true},
                {label:'Nombre del centro de costo', name:'cost_center_name', isShow: true},
                {label:'Valor inicial del rubro', name:'value_item', isShow: true},
                {label:'Valor de la adición', name:'value_eddition', isShow: true},
                {label:'Valor total del rubro', name:'total_total', isShow: true},
            ]"
            class-container="" class-table="table table-bordered" :is-remove="false">
...
@endpush
    ...
    @push('scripts')
        @if(isset($recargarPagina) && $recargarPagina)
        <script>
            // Llama a la función JavaScript después de que la página se ha cargado
            window.onload = function() {
                recargarPagina();
            };

            // Definición de la función recargarPagina
