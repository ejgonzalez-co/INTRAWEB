    ...
    <table-component
        ...
        <table-column label="@lang('crud.action')" :sortable="false" :filterable="false">
            <template slot-scope="row">
                ...
                <button v-if= "row.novelty_type != 'Asignación presupuestal'"  @click="edit(row)" data-backdrop="static" data-target="#modal-form-contractNews" data-toggle="modal" class="btn btn-white btn-icon btn-md" data-toggle="tooltip" data-placement="top" title="@lang('crud.edit')">
                ...
                <button v-if= "row.novelty_type != 'Asignación presupuestal'" 
