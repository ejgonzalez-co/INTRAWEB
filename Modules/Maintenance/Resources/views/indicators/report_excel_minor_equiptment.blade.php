<table border="1">
    ...
    <tbody>
             ...
             <tr>
                ...
                <td>{!! $value['mant_resume_equipment_machinery'] ? $value['mant_resume_equipment_machinery']['name_equipment'] : ''!!}</td>
                <td>{!! $value['mant_resume_equipment_machinery'] ? $value['mant_resume_equipment_machinery']['no_inventory'] : ''!!}</td>
