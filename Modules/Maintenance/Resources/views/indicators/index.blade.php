...
@section('title', trans('Indicadores'))

@section('section_img', '/assets/img/components/estadisticas.png')

@section('menu')
    @include('maintenance::layouts.menus.menu_indicators')
@endsection

@section('content')

    <crud name="Indicators" :resource="{default: 'indicators-index'}"  inline-template>
        <div>
            <!-- begin breadcrumb -->
            ...
            <!-- begin page-header -->
            <h1 class="page-header text-center m-b-35">Vista principal para administrar indicadores
            </h1>
            <!-- end page-header -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <form-indicator :data-form="dataForm"></form-indicator>
