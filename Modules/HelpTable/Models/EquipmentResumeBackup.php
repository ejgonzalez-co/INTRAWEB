 ...
 */
class EquipmentResumeBackup extends Model {
    use SoftDeletes;

    public $table = 'ht_tic_equipment_resume_backups';
    ...
    public static $rules = [
        ...
        'observation_internal_and_external_hardware_cleaning' => 'nullable|string|max:2000',
        ...
        'observation_power_supply_cleaning' => 'nullable|string',
        'has_dvd_drive_cleaning' => 'nullable|string|max:2',
        'observation_dvd_drive_cleaning' => 'nullable|string',
     ...
     **/
    public function EquipmentResume() {
        return $this->belongsTo(\Modules\HelpTable\Models\EquipmentResume::class, 'ht_tic_equipment_resume_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function EquipmentPurchaseDetailsBackups() {
        return $this->hasMany(\Modules\HelpTable\Models\EquipmentPurchaseDetailsBackup::class, 'ht_tic_equipment_resume_backups_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function OtherEquipmentBackups() {
        return $this->hasMany(\Modules\HelpTable\Models\EquipmentResumeOtherEquipmentBackup::class, 'ht_tic_equipment_resume_backups_id');
    }
}
