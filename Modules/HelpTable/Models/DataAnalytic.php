 ...
 *
 * @property \Modules\HelpTable\Models\TicRequestStatus $TicRequestStatus
 * @property \Modules\HelpTable\Models\TicTypeRequest $TicTypeRequest
 * @property \Modules\HelpTable\Models\TicTypeTicCategory $TicTypeTicCategories
 ...
 * @property \Illuminate\Database\Eloquent\Collection $TicKnowledgeBases
 * @property \Illuminate\Database\Eloquent\Collection $TicMaintenances
 * @property \Illuminate\Database\Eloquent\Collection $TicRequestHistories
 * @property \Illuminate\Database\Eloquent\Collection $TicSatisfactionPolls
 * @property integer $_tic_type_request_id
 * @property integer $_tic_request_status_id
 ...
 * @property integer $_tic_type_tic_categories_id
 * @property boolean $priority_request
 ...
 * @property boolean $survey_status
 * @property string $time_line
 * @property boolean $support_type
...
class DataAnalytic extends Model {
    ...
    public function ticMaintenances() {
        return $this->hasMany(\Modules\HelpTable\Models\TicMaintenance::class, 'ht_tic_requests_id');
    }
