<div class="table-responsive">
    <table-component id="configMice-table" :data="advancedSearchFilterPaginate()" sort-by="configMice" sort-order="asc"
        ...
        <table-column label="@lang('crud.action')" :sortable="false" :filterable="false">
            <template slot-scope="row">
                ...
                <button @click="edit(row)" data-backdrop="static" data-target="#modal-form-configMice"
                    data-toggle="modal" class="btn btn-white btn-icon btn-md" data-toggle="tooltip" data-placement="top"
                    title="@lang('crud.edit')">
                    <i class="fas fa-pencil-alt"></i>
                </button>

                <button @click="show(row)" data-target="#modal-view-configMice" data-toggle="modal"
                    class="btn btn-white btn-icon btn-md" data-toggle="tooltip" data-placement="top"
                    title="@lang('see_details')">
                    <i class="fa fa-search"></i>
                </button>

                <button @click="show(row)" data-target="#modal-view-mouse-history" data-toggle="modal"
