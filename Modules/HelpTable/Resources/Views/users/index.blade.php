...
@section('title', trans('Technicians'))
...
<crud name="users"
    :resource="{default: 'users', get: 'get-users'}"
    ...
    <div>
        ...
        <ol class="breadcrumb m-b-10">
            ...
            <li class="breadcrumb-item active">@lang('technicians')</li>
        </ol>
        <!-- end breadcrumb -->

        <!-- begin page-header -->
        <h1 class="page-header text-center m-b-35">@{{ '@lang('main_view_to_manage') @lang('accounts') @lang('off') @lang('technicians')' | capitalize}}</h1>
        <!-- end page-header -->
        ...
        <div class="row">
            <widget-counter
                ...
                :qty="dataList.filter((data) =>  data.email_verified_at !== null && data.block === 0).length"
            ...
            <widget-counter
                ...
                :qty="dataList.filter((data) =>  data.block === 1 ).length"
        ...
        <!--
        <div class="m-t-20">
            <button @click="callFunctionComponent('add-user', 'loadAddUser');" type="button" class="btn btn-primary m-b-10">
                <i class="fa fa-plus mr-2"></i>@lang('crud.create') @lang('technicians')
            </button>
        </div>
        -->
        <!-- end main buttons -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading border-bottom">
                <div class="panel-title">
                    <h5 class="text-center"> @{{ `@lang('total_registers') @lang('technicians'): ${dataPaginator.total}` | capitalize }}</h5>
                </div>
            ...
            <div id="accordion" class="accordion">
                ...
                <div id="collapseOne" class="collapse border-bottom p-l-40 p-r-40" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                <select-check css-class="form-control" name-field="id_dependencia" reduce-label="nombre" name-resource="/intranet/get-dependencies" :value="searchFields" :is-required="true"></select-check>
                                <small>Filtro por dependencia</small>
                            </div>
                            <div class="col-md-4">
                                <select-check css-class="form-control" name-field="id_cargo" reduce-label="nombre" name-resource="/intranet/get-positions" :value="searchFields" :is-required="true"></select-check>
            ...
            <div class="panel-body">
                ...
                @include('help_table::users.table')
            </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">@lang('info_of') @lang('technicians')</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times text-white"></i></button>
                    </div>
                    <div class="modal-body hljs-wrapper">
                        @include('help_table::users.show_fields')
                    </div>
        ...
        <add-technical-tic ref="add-user" name="users"></add-technical-tic>
