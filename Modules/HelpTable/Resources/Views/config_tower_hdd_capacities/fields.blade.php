...
<div class="form-group row m-b-15">
    {!! Form::label('hdd_capacity', trans('Capacidad HDD').':', ['class' => 'col-form-label col-12 col-lg-2 required']) !!}
    <div class="col-12 col-lg-4">
        {!! Form::text('hdd_capacity', null, [':class' => "{'form-control':true, 'is-invalid':dataErrors.hdd_capacity }", 'v-model' => 'dataForm.hdd_capacity', 'required' => true]) !!}
        <small>@lang('Enter the') @{{ `@lang('Capacidad HDD')` | lowercase }}</small>
        <div class="invalid-feedback" v-if="dataErrors.hdd_capacity">
            <p class="m-b-0" v-for="error in dataErrors.hdd_capacity">@{{ error }}</p>
        </div>
    </div>
