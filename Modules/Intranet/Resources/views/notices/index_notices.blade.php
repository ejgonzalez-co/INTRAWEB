                    ...
                    <div class="col-md-4 pt-4"  v-for="post in dataList">
                        <div class="card-content">
                            <div class="card-img d-flex align-items-center">
                                <img v-if="post.image_presentation == 'imagen_default_noticias.png'" :src="'{{ asset('assets/img') }}/'+post.image_presentation" alt=""style="opacity: 0.7;">
                                <img v-else :src="'{{ asset('storage') }}/'+post.image_presentation" alt="">
