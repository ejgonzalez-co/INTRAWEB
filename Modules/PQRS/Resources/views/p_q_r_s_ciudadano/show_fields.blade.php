...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <dd class="col-sm-9 col-md-9 col-lg-9" v-html="dataShow.motivos_hechos"></dd>
        </div>
        ...
        <span v-if="dataShow.pqr_correspondence">
            ...
            <div class="row" v-if="dataShow.pqr_correspondence?.document_pdf">
            ...
            <div class="row" v-if="dataShow.pqr_correspondence?.attached_document">
                <!-- Adjuntos Correspondence Received Id Field -->
...
<div v-if="dataShow.tipo_finalizacion" class="panel col-md-12" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        ...
        <div class="row" v-if="dataShow.pqr_correspondence_external">
            <!-- Adj Oficio Respuesta Field -->
            <dt class="col-sm-3 col-md-3 col-lg-3">Documento principal de la correspondencia enviada:</dt>
            <dd class="col-9" v-if="dataShow.pqr_correspondence_external.document_pdf && dataShow.pqr_correspondence_external.document_pdf.length > 0">
