...
<div class="panel col-md-12" data-sortable-id="ui-general-1">
    <!-- begin panel-heading -->
            ...
            <annotation-and-read :leido="dataShow.leido" campo="id" route-annotation="get-annotations" table-annotations="requerimiento_anotacion" :id-correspondence="dataShow.id"></annotation-and-read>
