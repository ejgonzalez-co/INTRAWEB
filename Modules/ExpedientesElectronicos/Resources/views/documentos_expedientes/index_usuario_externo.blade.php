...
<crud
    ...
    :resource="{default: 'documentos-expedientes', show: 'documentos-expedientes-detalle-usuario-externo', get: 'get-documentos-expedientes-usuario-externo?c={!! $c ?? null !!}'}"
    :init-values='{
    ...
    <div>
        ...
        <div class="m-t-20" style="display: flow-root;">
            @if($infoExpediente["estado"] == 'Abierto' && !Auth::check() && (session()->get('permiso') == 'Incluir información y editar documentos' || session()->get('permiso') == 'Incluir información y editar documentos (solo del usuario)'))
            ...
            @endif
            @if(!empty($infoExpediente["ee_permiso_usuarios_expedientes"]) && $infoExpediente["ee_permiso_usuarios_expedientes"][0]["limitar_descarga_documentos"] == 1)
