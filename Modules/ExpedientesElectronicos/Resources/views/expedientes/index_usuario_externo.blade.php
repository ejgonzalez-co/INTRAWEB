...
@section('menu')
@include('expedienteselectronicos::layouts.menu_usuario_externo')
@endsection
...
<crud
    name="expedientes"
    :resource="{default: 'expedientes', get: 'get-expedientes-usuario-externo'}"
    :init-values="{ee_permiso_usuarios_expedientes: [], metadatos:{}}"
    inline-template
    :init-values-search='{_obj_llave_valor_: {}, rol_consulta_expedientes: "usuario_externo"}'
    :crud-avanzado="true"
    >
    <div>
        <!-- begin breadcrumb -->
        <ol class="breadcrumb m-b-10">
            <li class="breadcrumb-item"><a href="{!! url('usuarios-externos') !!}">@lang('home')</a></li>
            <li class="breadcrumb-item active">@lang('Expediente')</li>
        </ol>
        <!-- end breadcrumb -->
        ...
        <!-- begin main buttons -->
        <div class="m-t-20">
            <button onclick="window.location.href = window.location.href.split('?')[0];" class="btn btn-light m-b-10 mr-2"><i class="fa fa-redo-alt mr-2"></i>Cargar página de nuevo</button>
            <button v-if="'{{ session('permiso') }}' === 'Incluir información y editar documentos' || '{{ session('permiso') }}' === 'Incluir información y editar documentos (solo del usuario)' || '{{ session('permiso') }}' === 'Consultar el expediente y sus documentos'" :href="'{!! url('expedientes-electronicos/documentos-expedientes-usuario-externo') !!}?c=' + dataList[0]?.encrypted_id" @click="$refs.expedientes.registrar_leido(dataList[0][customId], searchFields.rol_consulta_expedientes); this.location.href = '{!! url('expedientes-electronicos/documentos-expedientes-usuario-externo') !!}?c=' + dataList[0].encrypted_id" class="btn btn-light m-b-10"><i class="far fa-file-alt mr-2"></i>Administrar documentos</button>
        </div>
        <!-- end main buttons -->

        <div class="container-fluid bg-light py-4" v-if="dataList[0]">
            <div v-if="dataList[0].existe_fisicamente == 'Si'" class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-3">
                                <div class="bg-gray bor rounded-circle mr-2" style="width: 48px; height: 48px; display: flex; align-items: center; justify-content: center; color:white; font-size:1.2rem">
                                    <img v-if="dataList[0].image_responsable != null"
                                        class="w-100 rounded-circle" :src="'{{ asset('storage') }}/' + dataList[0].image_responsable" alt="" />
                                    <div v-else>@{{ dataList[0].name_responsable ? dataList[0].name_responsable.charAt(0) : 'N' }}</div>
                                </div>
                                <div class="col">
                                    <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2">
                                        <div class="mb-2">
                                            <p class="mb-0"><strong><i class="fas fa-user"></i> Responsable</strong></p>
                                            <p>@{{ dataList[0].name_responsable ? dataList[0].name_responsable : 'N/A' }}.</p>
                                        </div>

                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Nombre del expediente</strong></p>
                                            <p>@{{ dataList[0].nombre_expediente ? dataList[0].nombre_expediente : 'N/A' }}.</p>
                                        </div>
                                        <div class="mb-2">
                                            <p class="mb-0"><strong> Fecha inicio del expediente</strong></p>
                                            <p>@{{ dataList[0].fecha_inicio_expediente ? dataList[0].fecha_inicio_expediente : 'N/A' }}.</p>
                                        </div>
                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Oficina productora</strong></p>
                                            <p>@{{ dataList[0].oficina_productora_clasificacion_documental?.nombre ?? 'No asignada' }}.</p>
                                        </div>

                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Estado</strong></p>
                                            <p>@{{ dataList[0].estado }}.</p>
                                        </div>
                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Serie</strong></p>
                                            <p>@{{ dataList[0].serie_clasificacion_documental?.name_serie ?? 'No asignada' }}.</p>
                                        </div>

                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Subserie</strong></p>
                                            <p>@{{ dataList[0].subserie_clasificacion_documental?.name_subserie ?? 'No asignada' }}.</p>
                                        </div>
                                        <div class="mb-2">
                                            <p class="mb-0"><strong>Observación de la aprobación y/o devolución</strong></p>
                                            <p>@{{ dataList[0].observacion_accion ? dataList[0].observacion_accion : 'N/A' }}.</p>
                                        </div>
                                        <div class="mb-2">
                                            <p class="mb-0"><strong><i class="fas fa-info-circle"></i> Observación</strong></p>
                                            <p>@{{ dataList[0].observacion ? dataList[0].observacion : 'N/A' }}.</p>
                                        </div>

                                        <div class="mb-2">
                                            <p class="mb-0"><strong><i class="fas fa-stream"></i> Descripción</strong></p>
                                            <p>@{{ dataList[0].descripcion ? dataList[0].descripcion : 'N/A' }}.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body h-100 d-flex flex-column">
                            ...
                            <div class="row flex-grow-1">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <p>@{{ dataList[0].ubicacion ? dataList[0].ubicacion : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong>Sede</strong></p>
                                    <p>@{{ dataList[0].sede ? dataList[0].sede : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-sitemap"></i> Dependencia</strong></p>
                                    <p>@{{ dataList[0].nombre_dependencia ? dataList[0].nombre_dependencia : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-archive"></i> Área de archivo</strong></p>
                                    <p>@{{ dataList[0].area_archivo ? dataList[0].area_archivo : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong>Estante</strong></p>
                                    <p>@{{ dataList[0].estante ? dataList[0].estante : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong>Módulo</strong></p>
                                    <p>@{{ dataList[0].modulo ? dataList[0].modulo : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-bars"></i> Entrepaño</strong></p>
                                    <p>@{{ dataList[0].entrepano ? dataList[0].entrepano : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-box"></i> Caja</strong></p>
                                    <p>@{{ dataList[0].caja ? dataList[0].caja : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong>Cuerpo</strong></p>
                                    <p>@{{ dataList[0].cuerpo ? dataList[0].cuerpo : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong>Unidad de conservación</strong></p>
                                    <p>@{{ dataList[0].unidad_conservacion ? dataList[0].unidad_conservacion : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-calendar-alt"></i> Fecha de archivo</strong></p>
                                    <p>@{{ dataList[0].fecha_archivo ? dataList[0].fecha_archivo : 'N/A' }}.</p>
                                </div>

                                <div class="col-md-6 mb-2">
                                    <p class="mb-0"><strong><i class="fas fa-list-ol"></i> Número de inventario</strong></p>
                                    <p>@{{ dataList[0].numero_inventario ? dataList[0].numero_inventario : 'N/A' }}.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-3" v-if="dataList[0].expediente_has_metadatos?.length > 0">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 g-3 d-flex flex-wrap">
                                <div class="col d-flex flex-column" v-for="metadato in dataList[0].expediente_has_metadatos">
                    ...
                    <div class="card mb-3 flex-grow-1">
                        <div class="card-body h-100 d-flex flex-column">
                            ...
                            <div class="">
                                ...
                                <dd>@{{ dataList[0].permiso_general_expediente ?? 'N/A' }}.</dd>
                            </div>

                            <div v-if="dataList[0].ee_permiso_usuarios_expedientes" class="flex-grow-1">
                                ...
                                <dd>
                                    <table id="anotaciones" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="dependencia_usuario in dataList[0].ee_permiso_usuarios_expedientes">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="anotaciones" class="table table-bordered mt-1">
                                ...
                                <tbody>
                                    <tr v-for="leido in dataList[0].expediente_leido">
                            ...
                            <table id="anotaciones" class="table table-bordered mt-1">
                                ...
                                <tbody>
                                    <tr v-for="anotacion in dataList[0].expediente_anotaciones">
                    ...
                    <div class="card" id="show_cards" data-sortable-id="ui-general-1">
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseExample">
                                {{-- <div class="col-md-12">
                        <button type="button" class="btn bg-success-lighter" @click="exportarHistorial('xlsx', dataList[0].id, 'external-received')"><i class="fas fa-file-download"></i> Exportar Historial</button>
                                </div> --}}
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <section id="conference-timeline">
                                                ...
                                                <div class="conference-timeline-content">
                                                    ...
                                                    <div class="timeline-article" v-for="(history, key) in dataList[0].ee_expediente_historials">
        ...
        {{-- <div id="show_table"  class="panel" title="Ver en lista" data-sortable-id="ui-general-1">
            ...
            <div class="panel-heading ui-sortable-handle">
                ...
                <button type="button" class="btn btn-white btn-icon btn-md" @click="exportarHistorial('xlsx', dataList[0].id, 'expediente')" title="Descargar flujo documental">
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <table class="table table-hover fix-vertical-table">
                            ...
                            <tbody>
                                <tr v-for="(history, key) in dataList[0].ee_expediente_historials">
