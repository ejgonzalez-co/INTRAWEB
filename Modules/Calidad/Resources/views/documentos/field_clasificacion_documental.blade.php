...
<div class="panel" data-sortable-id="ui-general-1">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group row m-b-15">
                    {!! Form::label('classification_subserie', 'Subserie: ', ['class' => 'col-form-label col-md-3 required']) !!}
                    <div class="col-md-9">

                        <select-check css-class="form-control" name-field="classification_subserie" reduce-label="name_subserie" :name-resource="'/documentary-classification/get-subseries-clasificacion?serie='+dataForm.classification_serie" :value="dataForm" :key="dataForm.classification_serie" :enable-search="true" :is-required="true"></select-check>
