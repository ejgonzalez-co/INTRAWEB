...
class DocumentoSolicitudDocumentalHistorial extends Model
{
    public $table = 'calidad_documento_solicitud_documental_historial';
    ...
    public static array $rules = [
        ...
        'calidad_documento_solicitud_documental_id' => 'required',
        'created_at' => 'nullable',
        'updated_at' => 'nullable',
        'deleted_at' => 'nullable'
    ];
