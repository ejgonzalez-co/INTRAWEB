...
{
    public $table = 'calidad_documento_tipo_documento';
    ...
    {
        return $this->hasMany(\Modules\Calidad\Models\Documento::class, 'calidad_documento_tipo_documento_id');
    }

    public function documentoHistorials(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\Modules\Calidad\Models\DocumentoHistorial::class, 'calidad_documento_tipo_documento_id');
    }
}
