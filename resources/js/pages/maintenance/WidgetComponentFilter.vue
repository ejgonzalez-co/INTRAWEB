<template>
    ...
    <div v-else :class="[classCssCol]">
        <div :class="['widget widget-stats']" :style="'background-color:'+bgColor">
            <div class="stats-icon"><i :class="icon"></i></div>
            <div class="stats-info">
                <h4 class="text-black-transparent-6"><strong v-html="title"></strong></h4>
...
import { Component, Prop, Watch, Vue, Emit  } from "vue-property-decorator";
     ...
     */
        @Component
        export default class WidgetComponentFilter extends Vue {
         ...
         */
        @Prop({ type: String, default: 'bg-blue' })
