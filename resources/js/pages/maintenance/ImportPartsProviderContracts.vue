<template>
   <div>
      ...
      <div class="modal fade" id="modal-form-import-spare-parts-provider-contracts">
         <div class="modal-dialog modal-lg">
            <form @submit.prevent="store()" id="form-import-spare-parts-provider-contracts">
               <div class="modal-content border-0">
                  <div class="modal-header bg-blue">
                     <h4 class="modal-title text-white">Formulario de importación de repuestos</h4>
                  ...
                  <div class="modal-body">
                     ...
                     <a href="/storage/maintenance/documents_public/Modelo de importacion de repuestos.xlsx" target="_blank">Descargar formato de importación de repuestos.</a>
   ...
   */
   ...
   export default class AssetsCreate extends Vue {
      ...
      public loadAssets(dataElement: number): void {
         this.dataForm = {provider_id: dataElement};
         $('#modal-form-import-spare-parts-provider-contracts').modal('show');
      }
      ...
      public store(): void {
         ...
         axios.post("import-parts-provider-cont/"+this.dataForm.provider_id, this.makeFormData(), { headers: { 'Content-Type': 'multipart/form-data' } })
         .then((res) => {
            ...
            $(`#modal-form-import-spare-parts-provider-contracts`).modal('toggle');
