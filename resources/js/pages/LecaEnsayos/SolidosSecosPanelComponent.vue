                            ...
                            >
                                <template slot-scope="row">
                                    ...
                                    <a
                                        ...
                                        type="button"
                                        class="btn btn-white btn-icon btn-md"
                                        :href="'observaciones-dupli-' +nameFormulario +'?lc_ensayo_solidos_secos_id=' +row.id"
                                        title="Observaciones"
                                    >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-5">
                                                <input-operation
                                                    name-field="mgl"
                                                    :number-one="dataForm.campo_a"
                                                    :number-two="dataForm.campo_b"
                                                    :number-three="dataForm.volumen_muestra"
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <div class="row" id="VerDetalles">
                            ...
                            <dd class="col-9">{{ dataShow.campo_a }}</dd>

                            <dt class="text-inverse text-left col-3">
                                B:
                            </dt>
                            <dd class="col-9">{{ dataShow.campo_b }}</dd>

                            <dt class="text-inverse text-left col-3">
                                Mg/L:
                            </dt>
                            <dd class="col-9">{{ dataShow.mgl }}</dd>
...
export default class SolidosSecosPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        ...
        if (
            this.dataForm.campo_a == "" ||
            this.dataForm.campo_a == null ||
            this.dataForm.campo_b == "" ||
            this.dataForm.campo_b == null ||
            this.dataForm.hr == "" ||
            this.dataForm.hr == null ||
            this.dataForm.centigrados == "" ||
            this.dataForm.centigrados == null
        ) {
            this.$swal({
    ...
    public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["mgl"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + this.idMuestra)
            .then(res => {
                this.dataForm["add1"] = res.data.data["mgl"];
            })
            .catch(error => {});
    }
