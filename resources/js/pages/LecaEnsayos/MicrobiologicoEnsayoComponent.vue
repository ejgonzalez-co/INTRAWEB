...
export default class MicrobiologicoEnsayoComponent extends Vue {
    /**
    ...
    public datosSiembra() {
        axios
            ...
            .then(res => {
                ...
                this.fechaSeimbraEnsayo = this.allEnsayos["fecha_siembra"];
                this.fechaIncubacion = this.allEnsayos["fecha_incubacion"];
                this.dilucionUtilizada = this.allEnsayos["dilucion_utilizada"];
