<template>
    <div class="m-1">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <table-column
                                show="valor_turb_uno"
                                label="Valor de Turbiedad(1)en NTU sin BaCI2"
                            ></table-column>
                            <table-column
                                show="valor_turb_dos"
                                label="Valor de Turbiedad(2)en NTU con BaCI2"
                            ></table-column>
                            <table-column
                                show="sulfato_resultado_a"
                                label="Sulfatos mg SO4/L"
                            ></table-column>
                            <table-column
                                show="tipo"
                                label="Tipo"
                                ...
                                <template slot-scope="row">
                                    ...
                                    <button
                                        v-if="
                                            row.tipo == 'Duplicado'
                                        "
                                        @click="showRegPro(row)"
                                        data-target="#modal-show-promedio"
                                        data-toggle="modal"
                                        class="btn btn-white btn-icon btn-md"
                                        data-placement="top"
                                        title="Información promedio"
                                    >
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading ui-sortable-handle">
                                    <h4 class="panel-title">
                                        <strong>Ingrese los datos para la ejecución del ensayo</strong>
                                    </h4>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Valor de Turbiedad(1)en NTU sin BaCI2: </label
                                            >
                                            <div class="col-md-5">
                                                <!-- <input
                                                    class="form-group form-control"
                                                    type="number"
                                                    v-model="dataForm.valor_turb_uno"
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.valor_turb_uno"
                                                    :currency="{'prefix': ''}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Valor de Turbiedad(2)en NTU con BaCI2</label
                                            >
                                            <div class="col-md-5">
                                               <!-- <input
                                                    class="form-group form-control"
                                                    type="number"
                                                    v-model="dataForm.valor_turb_dos"
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.valor_turb_dos"
                                                    :currency="{'prefix': ''}"
                                    ...
                                    <div class="col-md-6" v-if="dataForm.buffer == 'A'">
                                        <!-- Proceso -->
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Sulfatos mg SO4/L:</label
                                            >
                                            <div class="col-md-6">
                                                <input-operation
                                                    class="form-group"
                                                    name-field="sulfato_resultado_a"
                                                    :number-one="dataForm.valor_turb_uno"
                                                    :number-two="dataForm.valor_turb_dos"
                                                    :number-sulfato="blainterceptoA"
                                                    :number-penda="blapendienteA"

                                                    :key="
                                                        dataForm.valor_turb_uno +
                                                        dataForm.valor_turb_dos + 
                                                        blainterceptoA +
                                                        blapendienteA
                                                    "
                                                    :cantidad-decimales="
                                    ...
                                    <div class="col-md-6" v-else>
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-6">
                                                <input-operation
                                                    class="form-group"
                                                    name-field="sulfato_resultado_b"
                                                    :number-one="dataForm.valor_turb_uno"
                                                    :number-two="dataForm.valor_turb_dos"
                                                    :number-sulfato="blainterceptoB"
                                                    :number-penda="blapendienteB"
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-5">
                                                <input
                                                    class="form-group form-control"
                                                    type="text"
                                                    v-model="dataForm.concentracion"
                                                />
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="modal-ejecutar-duplicado">
            ...
            <div class="modal-body">
                ...
                <div class="panel" data-sortable-id="ui-general-1">
                    ...
                    <div  class="col-md-6"  v-if="idMuestra.duplicado == 'Si'"  >                   

                            <!-- Proceso -->
                            <div class="form-group row m-b-15">
                                <label  class="text-inverse text-left col-6" >Método de ensayo:</label>
                                <div class="col-md-5">
                                    <select  v-model="metodoTotal"  class="form-group form-control" >
                                        <option value="Seleccione" >Seleccione</option  >
                                        <option value="Duplicado" >Duplicado</option >
                                        <option value="Repetición" >Repetición</option >
                                        <option  value="Regla de decisión"  >Regla de decisión</option  >
                                    </select>
                                </div>
                            </div>
                </div>
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <div class="row" id="VerDetalles">
                            ...
                            <dd class="col-9">{{ dataShow.volumen_muestra }}</dd>

                            <dt class="text-inverse text-left col-3">
                                Buffer:
                            </dt>
                            <dd class="col-9">{{ dataShow.buffer }}</dd>

                            <dt class="text-inverse text-left col-3">
                                Formula:
                            </dt>
                            <dd class="col-9">{{ dataShow.formula }}</dd>

                            <dt class="text-inverse text-left col-3">
                                Sulfatos mg SO4/L:
                            </dt>
                            <dd class="col-9">{{ dataShow.sulfato_resultado_a }}</dd>
        ...
        <div class="modal fade" id="modal-show-promedio">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">Información promedio</h4>
                        <button
                            type="button"
                            class="close"
                            data-dismiss="modal"
                    ...
                    <div class="modal-body">
                        <div class="row" id="verPromedio">
                            <!-- State Routine Field -->
                            <dt class="text-inverse text-left col-3">
                                Promedio (X):
                            </dt>
                            <dd class="col-9">{{ dataShow.resultado_promedio }}</dd>
                    ...
                    <div class="modal-footer">
                        <button
                            class="btn btn-warning"
                            type="button"
                            @click="printContent('verPromedio')"
                        >
                            <i class="fa fa-print mr-2"></i>Imprimir
                        </button>
                        <button class="btn btn-white" data-dismiss="modal">
...
export default class SulfatoPanelComponent extends Vue {
    /**
    ...
    /**
     * Intercepto blanco interceptoA
     */
    public blainterceptoA: any;

    /**
     * Intercepto blanco interceptoA
     */
    public blapendienteA: any;

    /**
     * Intercepto blanco interceptoA
     */
    public blainterceptoB: any;

    /**
     * Intercepto blanco interceptoA
     */
    public blapendienteB: any;
     ...
     */
    public interceptoUno: any;

    /**
     * Datos del usuario en sesion
     */
    public interceptoDos: any;

        /**
     * Datos del usuario en sesion
     */
    public pendienteUno: any;

    /**
     * Datos del usuario en sesion
     */
    public pendienteDos: any;
    ...
    constructor() {
        ...
        this.add1 = 0;
        this.add2 = 0;
        this.interceptoUno = 0;
        this.interceptoDos = 0;
        this.pendienteUno = 0;
        this.pendienteDos = 0;
        ...
        this.blainterceptoA = 0;
        this.blapendienteA = 0;
        this.blainterceptoB = 0;
        this.blapendienteB = 0;
     ...
     *
     * @author Manuel Marin Londoño. - Junio. 15 - 2022
     * @version 1.0.0
     */
    public storeBlanco(): void {
        ...
        if (
            ...
            this.dataForm.buffer == "" ||
            this.dataForm.buffer == null ||
            this.dataForm.formula == "" ||
            this.dataForm.formula == null ||
            this.dataForm.valor_turb_uno == "" ||
            this.dataForm.valor_turb_uno == null ||
            this.dataForm.valor_turb_dos == "" ||
            this.dataForm.valor_turb_dos == null
        ) {
            this.$swal({
    ...
    public datosPatronFunction() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.datosBlanco = res.data.data;
                this.interceptoUno = this.datosBlanco["intercepto_uno"];
                this.interceptoUno = res.data.data.intercepto_uno;
                this.interceptoDos = res.data.data.interceptoDos;
                this.pendienteUno = res.data.data.pendiente_uno;
                this.pendienteDos = res.data.data.pendiente_dos;
     ...
     * @version 1.0.0
     */
    public showRegPro(dataElement: object) {
        this.dataShow = dataElement;

        $(`#modal-show-promedio`).modal("toggle");
    }
     ...
     */
     public datosFormulas() {
        axios
            .get("get-datos-formulas-" + this.nameFormulario)
            .then(res => {
                let request = res.data.data;
                this.blainterceptoA = request["intercepto_uno"];
                this.blapendienteA = request["pendiente_uno"];
                this.blainterceptoB = request["intercepto_dos"];
                this.blapendienteB = request["pendiente_dos"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
    ...
    public storeDuplicado(dataElement: object) {
        ...
        this.dataForm["metodo"] = "Duplicado";
    ...
    public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["sulfato_resultado_a"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + dataElement["id"])
            .then(res => {
                this.dataForm["add1"] = res.data.data["sulfato_resultado_a"];
            })
            .catch(error => {});
    }
