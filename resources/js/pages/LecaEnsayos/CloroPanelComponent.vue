                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            ></table-column>
                            <table-column
                                show="volumen_titulacion"
                                label="V FAS gastado"
                            ></table-column>
                            <table-column
                                show="concentracion"
                                label="Concentración FAS"
                            ></table-column>
                            <table-column
                                show="resultado"
                                label="Cloro residual mgCI2/L"
                            >
                                <template
                                    slot-scope="row"
                                    :sortable="false"
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraBlanco.volumen_titulacion }}
                                    </dd>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraPatron.volumen_titulacion }}
                                    </dd>
...
export default class CloruroPanelComponent extends Vue {
    ...
    public cargaConcentracion() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.datoConcentracion = res.data.data["concentracion_fas"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
