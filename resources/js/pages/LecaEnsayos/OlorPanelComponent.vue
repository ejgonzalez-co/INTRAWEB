                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                ><i class="icon-ostatus-colored"></i>Olor: </label
                                            >
                                            <div class="col-md-5">
                                                <!-- <input
                                                     class="form-group form-control"
...
export default class OlorPanelComponent extends Vue {
    /**
     ...
     */
     public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["olor"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + dataElement["id"])
            .then(res => {
                this.dataForm["add1"] = res.data.data["olor"];
            })
            .catch(error => {});
    }
