                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <table-column
                                ...
                                label="Volumen NaOH mL (gastado)"
                            ></table-column>
                            <table-column
                                show="concentracion"
                                label="Concentración N (Eq-g/L)"
                            ></table-column>
                            <table-column
                                show="ph"
                                label="pH (Final de la titulación)"
                            ></table-column>
                            <table-column
                                show="resultado"
                                label="Acidez mg/L CaCo3"
                            >
                                <template
                                    slot-scope="row"
                                    :sortable="false"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        <label
                                            class="text-inverse text-left col-6 required"
                                            >pH (Final de la titulación)</label
                                        >
                                        <div class="col-md-5">
                                            <!-- <input
                                               class="form-group form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        <label
                                            class="text-inverse text-left col-6 required"
                                            >Concentración adicionado</label
                                        >
                                        <div class="col-md-5">
                                            <input
                                               class="form-group form-control"
        ...
        <div class="modal fade" id="modal-ejecutar-duplicado">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <!-- Formulario de metodo de ejecucion -->
                        <div class="panel" data-sortable-id="ui-general-1">
                            <div class="modal-body">
                                <!-- Type Field -->
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" id="VerDetalles">
                            ...
                            <dt class="text-inverse text-left col-3 mt-5">
                                pH (Final de la titulación):
                            </dt>
                            <dd class="col-9 mt-5">{{ dataShow.ph }}.</dd>
...
export default class AlcalinidadPanelComponent extends Vue {
    ...
    public cargaUltimoBlanco() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.ultimoBlanco = res.data.data["resultado_completo"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
