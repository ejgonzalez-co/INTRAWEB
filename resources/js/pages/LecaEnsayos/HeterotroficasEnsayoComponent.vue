<template>
    <div class="m-1">
                    ...
                    <div class="col">
                        <div class="col-md-10">
                            <button
                                ...
                                data-toggle="modal"
                            >
                                Seleccione el tendido de muestras para este
                                ensayo
                            </button>
                        </div>
        ...
        <div class="panel mt-3" data-sortable-id="ui-general-1" v-if="this.selectMue != ''">
            ...
            <div class="panel-body mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row m-b-15">
                                    <label
                                        class="text-inverse text-left col-6 required"
                                        >Dilución utilizada(Factor/Cálculo):</label
                                    >
                                    <div class="col-md-5">
                                        <!-- <input
                                            class="form-group form-control"
                ...
                <div class="panel" data-sortable-id="ui-general-1" v-if="allEnsayos != null || validarCampos == 2">
                    <div class="panel-body">
                        <div class="panel-heading ui-sortable-handle">
                            <h4 class="panel-title">
                        ...
                        <div class="row mt-3">
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-5">
                                            <!-- <input
                                                ...
                                                type="number"
                                                v-model="
                                                    dataForm.p_positivos
                                                "
                                            /> -->
                                            <currency-input
                                                v-model="dataForm.p_positivos"
                                                :currency="{'prefix': ''}"
                                                locale="es"
                                                :precision="3"
                                                class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row m-b-15">
                                    <label
                                        class="text-inverse text-left col-6"
                                        >Resultado general (NMP/100mL):</label
                                    >
                                    <div class="col-md-5">
                                        <input
                                            style="cursor:not-allowed; background-color: #e9ecef;"
                ...
                <div class="modal-footer mt-5">
                    <button @click="updateEnsayo()" class="btn btn-primary" v-if="buttonVar != 'Guardar'">
                        <i class="fa fa-save mr-2"></i>Guardar
                    </button>
                    <button @click="storeEnsayo()" class="btn btn-primary" v-else>
                        <i class="fa fa-save mr-2"></i>Guardar
                    </button>
                </div>
            </div>
...
export default class HeterotroficasEnsayoComponent extends Vue {
    /**
     ...
     * Datos del usuario en sesion
     */
    public totalDosis: any;

    /**
     * Datos para validar los campos
     */
    public validarCampos: any;


    /**
     * Valriable para el boton de guardar
     */
    public buttonVar: any;
     ...
     * Fecha siembra
     */
    public fechaSeimbraEnsayo: any;

    /**
     * Fecha incubacion
     */
    public fechaIncubacion: any;

    /**
     * Fecha incubacion
     */
    public dilucionUtilizada: any;
    ...
    constructor() {
        ...
        this.fechaSeimbraEnsayo = 0;
        this.dilucionUtilizada = 0;
        this.fechaIncubacion = 0;
        this.decimalEnsayo = 4;
        this.codigoMuestra = "";
        this.usersR = "";
        this.totalDosis = 0;
        this.validarCampos = 0
        this.buttonVar = "";
        this.prueba = 4;
    ...
    public datosSiembra() {
        ...
        axios
            .get("get-datos-siembra-" + this.nameFormulario)
            .then(res => {
                // Llena la lista de datos
                this.allEnsayos = res.data.data;
                if (this.allEnsayos.length == 0) {
                    this.allEnsayos = null;
                }
                this.fechaSeimbraEnsayo = this.allEnsayos[0]["fecha_siembra"];
                this.fechaIncubacion = this.allEnsayos[0]["fecha_incubacion"];
                this.dilucionUtilizada = this.allEnsayos[0]["dilucion_utilizada"];
                // this.blapendiente = this.allEnsayos["k_pendiente"];
                // this.blacurva = this.allEnsayos["fecha_siembra"];

                this.userRespon();
            })
            .catch(err => {
                this.allEnsayos = null;
                this.buttonVar = "Guardar";
                console.log(this.buttonVar);
                console.log("Error al obtener la lista.");
            });
    }
     ...
     * @version 1.0.0
     */
    public obtenerDosis(): void{

        this.dataForm["p_positivos"] = this.dataForm['p_positivos'];
        if(this.dataForm["p_positivos"] >= 85){
            this.$swal({
            ...
            axios
            .post("dosis-" + this.nameFormulario, this.dataForm)
            .then(res => {
                let request = res.data.data[0]['resultado_mpn'];
                this.totalDosis = request;
    ...
    public storeEnsayo(): void {
        ...
        this.dataForm["resultado"] = this.dataForm['p_positivos'];
        ...
        this.dataForm["fecha_siembra"] = this.fechaSeimbraEnsayo;
        this.dataForm["fecha_incubacion"] = this.fechaIncubacion;
        this.dataForm["dilucion_utilizada"] = this.dilucionUtilizada;
        this.dataForm["idMuestra"] = this.selectMue;
        this.dataForm["resultado_general"] = this.dataForm[
        "resultadoGeneral"
        ]?.toFixed(this.decimalBlanco);
        this.dataForm["resultado_general_ufc"] = this.dataForm[
            "resultadoUfcB"
        ]?.toFixed(this.decimalBlanco);
        //Se valida que estos datos no vengan vacios
        ...
        if (
            ...
            this.dataForm.fecha_incubacion == "" ||
            this.dataForm.fecha_incubacion == null ||
            this.dataForm.hora_incubacion == "" ||
            this.dataForm.hora_incubacion == null ||
            this.dataForm.dilucion_utilizada == "" ||
            this.dataForm.dilucion_utilizada == null
        ) {
            this.$swal({
    ...
    public updateEnsayo(): void {
        ...
        this.dataForm["dilucion_utilizada"] = this.dilucionUtilizada;
        this.dataForm["idMuestra"] = this.selectMue;
        this.dataForm["resultado_general"] = this.totalDosis;
        this.dataForm["hora_siembra"] = this.dataForm.hora_siembra;
        this.dataForm["hora_incubacion"] = this.dataForm.hora_incubacion;
        // this.dataForm["resultado_general_ufc"] = this.dataForm[
        //     "resultadoUfcB"
        // ]?.toFixed(this.decimalBlanco);
        ...
        console.log('parameter1:',this.dataForm["idMuestra"] );
        console.log('parameter2:', this.dataForm.hora_siembra);
        console.log('parameter3:',this.dataForm.fecha_incubacion );
        console.log('parameter4:', this.dataForm.hora_incubacion);
        console.log('parameter5:',this.dataForm.dilucion_utilizada );
        console.log('parameter1:',this.dataForm );
        ...
        if (
            ...
            if (this.datosBlanco) {
                console.log('entra ajn',this.dataForm["idMuestra"]['sample_reception_code']);
                axios
                // .put("ensayo-" + this.nameFormulario, this.dataForm)
                .put("ensayo-" + this.nameFormulario + "/" + this.dataForm["idMuestra"]["id"], this.dataForm)
                    // .post("ensayo-update" + this.nameFormulario + "/" + this.dataForm["idMuestra"])
                    .then(res => {
                        if (res.data.data == "Si") {
                            this.$swal({
                                title: "Análisis Guardado !",
