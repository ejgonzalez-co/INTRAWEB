...
export default class ColorPanelComponent extends Vue {
    /**
     ...
     */
     public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["color"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + dataElement["id"])
            .then(res => {
                this.dataForm["add1"] = res.data.data["color"];
            })
            .catch(error => {});
    }
}
