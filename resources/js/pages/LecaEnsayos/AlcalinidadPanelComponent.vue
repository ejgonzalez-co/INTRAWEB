                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            ></table-column>
                            <table-column
                                show="volumen_muestra"
                                label="Volumen muestra (mL)"
                            ></table-column>
                            <table-column
                                show="normalidad_solucion"
                                label="Normalidad de la solución H2SO4"
                            ></table-column>
                            <table-column
                                show="resultado"
                                label="Alcalinidad total mg CaCo3/L"
                            >
                                <template
                                    slot-scope="row"
                                    :sortable="false"
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-heading ui-sortable-handle">
                                    <h4 class="panel-title">
                                        <strong
                                            >Seleccione con que fórmula
                                            calculará la Alcalinidad</strong
                                        >
                                    </h4>
                                </div>
                                <div class="row mt-3">
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-6">
                                                <select
                                                    ...
                                                    class="form-control"
                                                    v-model="
                                                        dataForm.alcalinidad_select
                                                    "
                                                    name="alcalinidad_select"
                                                    id="alcalinidad_select"
                                                >
                                                    <option disabled value=""
                                                        >Seleccione</option
                                                    >
                                                    <option value="≥ 20 mg/L"
                                                        >≥ 20 mg/L</option
                                                    >
                                                    <option value="≤ 20 mg/L"
                                                        >≤ 20 mg/L</option
                        ...
                        <div
                            ...
                            v-if="dataForm.alcalinidad_select == '≤ 20 mg/L'"
                        >
                            <div class="panel-body">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input
                                                   class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.volumen_muestraa
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.volumen_muestraa"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Volumen total del H2SO4 gastado
                                                (mL) c=0,3 pH:</label
                                            >
                                            <div class="col-md-5">
                                                <!-- <input
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input
                                                   class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.normalidad_soluciona
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.normalidad_soluciona"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                ...
                                <div class="row mt-3">
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input
                                                   class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.volumen_muestrab
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.volumen_muestrab"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input
                                                   class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.normalidad_solucionb
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.normalidad_solucionb"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Alcalinidad total mg 2
                                                CaCo3/L:</label
                                            >
                                            <input-operation
                                                name-field="resultadob"
                                                :number-one="
                                                    parseFloat(
                                                        dataForm.volumen_muestrab
                                                    )
...
<!-- <div class="panel" data-sortable-id="ui-general-1">
    <div class="panel-body">
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    readonly
                                                />
                                            <!-- <input-operation suffix=' %' operation="consulta" :cantidad-decimales="2" :ruta="'get-valor-dpr/'+ codigoMuestra" name-field="resultado" :key="keyRefresh" :value="dataForm"  ></input-operation> -->
                    ...
                    <div class="panel" data-sortable-id="ui-general-1">
                        <div class="modal-body">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                >
                                                    <option value="Seleccione"
                                                        >Seleccione</option
                                                    >
                                                    <option value="Patrón de 10"
                                                        >Patrón de 10</option
                                                    >
                                                    <option value="Patrón de 50"
                                                        >Patrón de 50</option
                                                    >
                                                    <option value="LCM"
                                                        >LCM</option
                            ...
                            <div
                                ...
                                data-sortable-id="ui-general-1"
                                v-if="
                                    dataForm.alcalinidad_select == '≤ 20 mg/L'
                                "
                            >
                                <div class="panel-body">
                                    <div class="row mt-3">
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <div class="row" id="VerDetalles">
                            ...
                            <dd class="col-9 mt-5">
                                {{ dataShow.volumen_muestra }}
                            </dd>

                            <dt class="text-inverse text-left col-3 mt-5">
                                Normalidad de la solución H2SO4:
                            </dt>
                            <dd class="col-9 mt-5">
                                {{ dataShow.normalidad_solucion }}
                            </dd>

                            <dt
                                class="text-inverse text-left col-3 mt-5"
                                v-if="
                                    dataShow.alcalinidad_select == '≥ 20 mg/L'
                                "
                            >
                                Volumen (mL) H2SO4 F:
                            </dt>
                            <dt
                                ...
                                v-else
                            >
                                Volumen total del H2SO4 gastado (mL) c=0,3 pH
                            </dt>
                            <dd class="col-9 mt-5">
                                {{ dataShow.volumen_f }}
                            </dd>
                            ...
                            <dt
                                ...
                                v-else
                            >
                                Volumen (mL) gastado b=4,3 pH a 4,7 pH
                            </dt>
                            <dd class="col-9 mt-5">
                                {{ dataShow.volumen_m }}
                            </dd>
        ...
        <!-- begin #modal-ejecutar-blanco -->
        <div class="modal fade" id="modal-show-ensayo-alcalinidad">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">Ver detalles</h4>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraBlanco.normalidad_solucion }}
                                    </dd>
                                </div>
                                <div class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt
                                        class="text-inverse text-left col-2"
                                        v-if="
                                            muestraBlanco.alcalinidad_select ==
                                                '≥ 20 mg/L'
                                        "
                                    >
                                        Volumen (mL) H2SO4 F:
                                    ...
                                    <dt
                                        ...
                                        v-else
                                    >
                                        Volumen total del H2SO4 gastado (mL)
                                        c=0,3 pH
                                    </dt>
                                    <dd class="col-4">
                                        {{ muestraBlanco.volumen_f }}
                                    </dd>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraBlanco.alcalinidad_total }}
                                    </dd>
                                </div>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraPatron.normalidad_solucion }}
                                    </dd>
                                </div>
                                <div class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt
                                        class="text-inverse text-left col-2"
                                        v-if="
                                            muestraPatron.alcalinidad_select ==
                                                '≥ 20 mg/L'
                                        "
                                    >
                                        Volumen (mL) H2SO4 F:
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraPatron.alcalinidad_total }}
                                    </dd>
                                </div>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                <div style="padding: 15px">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <dt
                                            ...
                                            v-else
                                        >
                                            Volumen (mL) gastado b=4,3 pH a 4,7
                                            pH
                                        </dt>
                                        <dd class="col-4">
                                            {{ item.volumen_m }}
                                ...
                                <div v-if="item.tipo == 'Duplicado'">
                                    <div
                                        v-for="(itema,
                                        key) in item.dpr_pr_alcalinidad"
                                        :key="key"
                                    >
                                        <div
                                            v-if="
...
export default class AlcalinidadPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        ...
        if (this.dataForm.alcalinidad_select == "≤ 20 mg/L") {
            this.dataForm[
                "alcalinidad_select"
            ] = this.dataForm.alcalinidad_select;
            this.dataForm[
                "normalidad_solucion"
            ] = this.dataForm.normalidad_soluciona;
            this.dataForm["volumen_f"] = this.dataForm.volumen_fa;
            this.dataForm["volumen_m"] = this.dataForm.volumen_ma;
            this.dataForm["volumen_muestra"] = this.dataForm.volumen_muestraa;

            this.dataForm["cantidadDecimales"] = this.decimalBlanco;
            this.dataForm[
                "alcalinidad_total"
            ] = this.dataForm.resultadoa.toFixed(this.decimalBlanco);
            this.dataForm["resultado"] = this.dataForm.resultadoa;
        } else {
            if (this.dataForm.alcalinidad_select == "≥ 20 mg/L") {
                this.dataForm[
                    "alcalinidad_select"
                ...
                this.dataForm[
                    "normalidad_solucion"
                ] = this.dataForm.normalidad_solucionb;
                this.dataForm["volumen_f"] = this.dataForm.volumen_fb;
                this.dataForm["volumen_m"] = this.dataForm.volumen_mb;
                this.dataForm[
                    "volumen_muestra"
                ] = this.dataForm.volumen_muestrab;

                this.dataForm["cantidadDecimales"] = this.decimalBlanco;
                this.dataForm[
                    "alcalinidad_total"
                ] = this.dataForm.resultadob.toFixed(this.decimalBlanco);
                this.dataForm["resultado"] = this.dataForm.resultadob;
            }
        }
        ...
        if (
            ...
            this.dataForm["volumen_m"] == "" ||
            this.dataForm["volumen_m"] == null ||
            this.dataForm["volumen_f"] == "" ||
            this.dataForm["volumen_f"] == null ||
            this.dataForm["normalidad_solucion"] == "" ||
            this.dataForm["normalidad_solucion"] == null
        ) {
            this.$swal({
    ...
    public print (): void {
        ...
        console.log('print ' , this.dataForm );
    }
    ...
    public datosBlancoFunction() {
        console.log ('storePatron', this.dataForm);
    ...
    /**
     * ejecutar el ensayo de alcalinidad
     *
     * @author Nicolas Dario Ortiz Peña. - Junio. 15 - 2022
     * @version 1.0.0
     */
    ...
    public datosPorcentualRelativa(dataElement: object) {
        this.codigoMuestra = dataElement["consecutivo"];
    ...
    public dprCalculate() {
        axios
            .get("get-dpr-promedio-" + this.nameFormulario + "/" + this.codigoMuestra)
            .then(res => {
                this.dprCal = res.data.data;
                console.log('dpr en 4085', this.dprCal );
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
    ...
    public storePorcentualRelativa(dataElement: object) {
        ...
        this.dataForm["resultado_completo"] = this.dprCal;
        this.dataForm["resultado"] = this.dprCal;
        if (
            // this.dataForm.add2 == "" ||
    ...
    public showRegTotal(dataElement: object) {
        ...
        $("#modal-show-ensayo-alcalinidad").modal("show");
    }
     ...
     * Aca se exportan los datos
     *
     * @author Seven Soluciones Informáticas. - Diciembre. 22 - 2022
     * @version 1.0.0
     */
     ...
     */
     public datosAdd(dataElement: object) {
        ...
        console.log('Resultado:',dataElement["resultado"]);
