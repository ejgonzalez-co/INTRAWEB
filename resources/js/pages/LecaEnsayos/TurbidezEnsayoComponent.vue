        ...
        <div class="panel mt-3" data-sortable-id="ui-general-1">
            ...
            <div class="panel-body mt-3">
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="panel" data-sortable-id="ui-general-1">
                        <div class="panel-body text-center">
                            <table class="tableTH" width="350" height="1" border="1" style="margin: 0 auto;">
                                <tr>
                                    <th colspan="2">
                                ...
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_uno"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_uno"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_dos"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_dos"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_tres"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_tres"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_cuatro"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_cuatro"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_cinco"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_cinco"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_seis"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_seis"] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ datosBlanco["rango_t_ntu_siete"] }}</td>
                                    <td>{{ datosBlanco["valor_mas_cer_siete"] }}</td>
                                </tr>
                            </table>
                        </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row m-b-15">
                                    <label
                                        ...
                                        >Lectura directa:</label
                                    >
                                    <div class="col-md-5">
                                        <!-- <input
                                            class="form-group form-control"
                                            type="number"
                                            v-model="dataForm.lectura"
                                        /> -->
                                        <currency-input
                                            v-model="dataForm.lectura"
                                            :currency="{'prefix': ''}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row m-b-15">
                                    <label
                                        class="text-inverse text-left col-6 required"
                                        >Expresión de resultados:</label
                                    >
                                    <div class="col-md-5">
                                        <!-- <input
                                            class="form-group form-control"
                                            type="number"
                                            v-model="dataForm.expresion"
                                        /> -->
                                        <currency-input
                                            v-model="dataForm.expresion"
                                            :currency="{'prefix': ''}"
...
export default class AlcalinidadEnsayoComponent extends Vue {
    ...
    public storeEnsayo(): void {
        ...
        if (
            this.dataForm["expresion"] == "" ||
            this.dataForm["expresion"] == null ||
            this.dataForm["lectura"] == "" ||
            this.dataForm["lectura"] == null
        ) {
            this.$swal({
