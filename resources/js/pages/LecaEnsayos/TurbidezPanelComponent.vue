                ...
                <div class="modal-content border-0">
                    ...
                    <div class="panel" data-sortable-id="ui-general-1">
                        ...
                        <div class="panel" data-sortable-id="ui-general-1">
                            ...
                            <div class="panel-body">
                                <h5><strong>Tipo de STD a ejecutar</strong></h5>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <!-- Proceso -->
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Tipo de patron:</label
                                            >
                                            <div class="col-md-5">
                                                <select-check
                                                css-class="form-control"
                                                name-field="tipo_patron"
                                                reduce-label="name"
                                                reduce-key="name"
                                                name-resource="get-std"
                                                :value="dataForm"
                                                :is-required="true">
                                                </select-check>
                                                <small>Seleccione el tipo de patron</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default class TurbidezPanelComponent extends Vue {
    /**
     ...
     */
     public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["expresion"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + this.idMuestra)
            .then(res => {
                this.dataForm["add1"] = res.data.data["expresion"];
            })
            .catch(error => {});
    }
