<template>
    <div class="m-1">
        <div>
            ...
            <div class="row m-5">
                ...
                <!--<div class="col">
                    ...
                    >
                        <h3 class="m-5 text-center text-white">Patrón</h3>
                    </div>
                    <h4
                        class="m-5 text-center"
                        v-if="ensayos['patron'] == false"
                ...
                <div class="col" style="padding-top: 100px;">
                    <div style="background-color: #6fb154" class="m-5">
                        <h3 class="m-5 text-center text-white">
                            Tiempo de espera para el resultado de este ensayo es
                            de 24 horas.
                        </h3>
                    </div>
                </div>
            ...
            <div class="m-t-20 mt-5">
                ...
                <!-- <button
                    v-if="
                        ensayos['patron'] == false && ensayos['blanco'] == true
                    "
                    ...
                    data-backdrop="static"
                >
                    <i class="fa fa-plus mr-2"></i>Ejecutar patrón
                </button>-->
                ...
                <div class="panel-body">
                    ...
                    <div class="float-xl-right m-b-15">
                        ...
                        <div class="btn-group">
                            ...
                            >
                                ...
                                <a
                                    href="javascript:;"
                                    @click="exportTableGoogleIp('xlsx')"
                                    class="dropdown-item text-white no-hover"
                                    ><i class="fa fa-file-excel mr-2"></i> EXCEL
                                    : DATOS IP
                                </a>
                    ...
                    <div class="table-responsive">
                        <table-component
                            ...
                            :cache-lifetime="0"
                        >
                            <table-column v-if="consecutivo != ''"
                                show="consecutivo"
                                label="Código de la muestra"
                            ></table-column>
                            <table-column v-else label="Código de la muestra">
                                <p class="text-center" style="border:1px solid #ff6000;border-radius:10px; background-color: rgba(252, 148, 12, 0.125); color: #ff6000;">Lectura Pendiente</p>
                            </table-column>
                            <table-column
                                show="created_at"
                            ...
                            <table-column
                                show="pozos_grandes"
                                label="Conteo pozos grandes"
                            ></table-column>
                            <!--<table-column
                                show="fecha_incubacion"
                                label="Fecha incubación"
                            ></table-column>-->
                            <table-column
                                show="pozos_pequeños"
                                label="Conteo pozos pequeños"
                            ></table-column>
                            <table-column
                                show="resultado_general"
                                label="Resultado"
                            ></table-column>
                            <table-column
                                show="tipo"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <!-- <label
                                                class="text-inverse text-left col-6"
                                                >Dilución
                                                utilizada(Factor/Cálculo):</label
                                            > -->
                                            <div class="col-md-5">
                                            <button 
                                                @click="obtenerPozos()"
                                                ...
                                                data-backdrop="static"
                                            >
                                                <i class="fa fa-search fa-fw mr-2 f-s-12"></i>Consultar
                                            </button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Requiere convertir resultado a
                                                UFC:</label
                                            >
                                            <div class="col-md-5">
                                                <select
                                                    v-model="
                                                        dataForm.convertir_ufc
                                                    "
                                                    class="field left form-control"
                                                >
                                    ...
                                    <div
                                        class="col-md-6"
                                        v-if="dataForm.convertir_ufc == 'Si'"
                                    >
                                        <!-- Proceso -->
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Resultado GENERAL (UFC/100mL):
                                            </label>
                                            <div class="col-md-5">
                                                <input-operation
                                                    name-field="resultadoUfcB"
                                                    :number-one="
                                                        totalPozos
                                                    "
                                                    :key="
        ...
        <!-- Aqui se ejecuta el porcentaje de recuperacion -->
        ...
        <!-- Aqui se ejecuta el porcentaje de relativa -->
        ...
        <div class="modal fade" id="modal-ejecutar-patron">
            <div class="modal-dialog modal-lg">
                <div class="modal-content border-0">
                    <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">Ejecutar patrón</h4>
                        <button
                            type="button"
                            class="close"
                            data-dismiss="modal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="panel" data-sortable-id="ui-general-1">
                            <div class="panel-body">
                                ...
                                <div class="panel-heading ui-sortable-handle">
                                    <h4 class="panel-title">
                                        <strong>Siembra e incubación</strong>
                                    </h4>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Hora de la siembra:</label
                                            >
                                            <div class="col-md-5">

                                                <hour-military
                                                    name-field="hora_siembra"
                                                    :value="dataForm"
                                                >
                                                </hour-military>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Hora de la incubación:</label
                                            >
                                            <div class="col-md-5">
                                                <hour-military
                                                    name-field="hora_incubacion"
                                                    :value="dataForm"
                                                >
                                                </hour-military>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Responsable de la siembra e incubación:</label
                                            >
                                            <div class="col-md-5">
                                                <input
                                                    style="cursor:not-allowed; background-color: #e9ecef;"
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-5">
                                                <!-- <input
                                                    ...
                                                    type="number"
                                                    v-model="
                                                        dataForm.dilucion_utilizada
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.dilucion_utilizada"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Hora de la lectura:</label
                                            >
                                            <div class="col-md-5">
                                                <hour-military
                                                    name-field="hora_lectura"
                                                    :value="dataForm"
                                                >
                                                </hour-military>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Resultado general (NMP/100mL):
                                            </label>
                                            <div class="col-md-5">
                                                <input-operation
                                                    name-field="resultadoGFinal"
                                                    :number-one="
                                                        totalPozos
                                                    "
                                                    :number-two="
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Responsable de la lectura:</label
                                            >
                                            <div class="col-md-5">
                                                <input
                                                    style="cursor:not-allowed; background-color: #e9ecef;"
                    ...
                    <div class="modal-body">
                        <div class="row" id="VerDetalles">
                            <dt class="text-inverse text-left col-3">
                                <i class="mdi mdi-content-save-off:"></i> pozo grandes:
                            </dt>
                            <dd class="col-9">{{ dataShow.pozos_grandes }}</dd>

                            <dt class="text-inverse text-left col-3">
                                <i class="mdi mdi-content-save-off:"></i> pozo pequeños:
                            </dt>
                            <dd class="col-9">{{ dataShow.pozos_pequeños }}</dd>
        ...
        <!-- Aqui se ven detalles del ensayo -->
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraBlanco.resultado_general }}
                                    </dd>

                                    <dt class="text-inverse text-left col-2">
                                        Requiere convertir resultado a UFC:
                                    </dt>
                                    <dd class="col-4">
                                        {{ muestraBlanco.convertir_ufc }}
                                    </dd>
                                </div>

                                <div v-if="muestraBlanco.convertir_ufc == 'Si'" class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                        Resultado GENERAL (UFC/100mL):
                                    </dt>
                                    <dd class="col-4">
                                        {{ muestraBlanco.resultado_general_ufc }}
                                    </dd>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">{{ item.fecha_siembra }}</dd>
                                </div>
                                <div class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                    ...
                                    <dt class="text-inverse text-left col-2">
                                        Fecha de la incubación:
                                    </dt>
                                    <dd class="col-4">{{ item.fecha_incubacion }}</dd>
                                </div>
                                <div class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                        Hora de la incubación:
                                    </dt>
                                    <dd class="col-4">
                                        {{ item.hora_incubacion }}
                                    </dd>

                                    <dt class="text-inverse text-left col-2">
                                        Dilución utilizada(Factor/Cálculo):
                                    </dt>
                                    <dd class="col-4">
                                        {{ item.dilucion_utilizada }}
                                    </dd>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                        Conteo pozos grandes:
                                    </dt>
                                    <dd class="col-4">
                                        {{ item.pozos_grandes }}
                                    </dd>
                                    <dt class="text-inverse text-left col-2">
                                        Conteo pozos pequeños:
                                    </dt>
                                    <dd class="col-4">
                                        {{ item.pozos_pequeños }}
                                    </dd>
                                ...
                                <div v-if="item.convertir_ufc == 'Si'" class="row mt-3">
                                    <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                        Resultado GENERAL (UFC/100mL):
                                    </dt>
                                    <dd class="col-4">
                                        {{ item.resultado_general_ufc }}
                                    </dd>
                                </div>
...
export default class MicrobiologicoPanelComponent extends Vue {
    /**
     ...
     * Datos del usuario en sesion
     */
    public totalPozos: any;


    /**
     * Datos de prueba para calcular con la dilucion
     */
    public prueba: any;
    ...
    public storeBlanco(): void {
        this.dataForm["resultado"] = this.totalPozos;
        ...
        this.dataForm["resultado_general"] = this.totalPozos;
        // this.dataForm["resultado_general_ufc"] = this.dataForm[
        //     "resultadoUfcB"
        // ].toFixed(this.decimalBlanco);
        this.dataForm["resultado_general_ufc"] = this.dataForm["resultadoUfcB"];
        if (
            this.dataForm.convertir_ufc == "" ||
            this.dataForm.convertir_ufc == null ||
            this.dataForm.p_grandes == "" ||
            this.dataForm.p_grandes == null ||
            this.dataForm.p_pequeños == "" ||
            this.dataForm.p_pequeños == null
        ) {
            this.$swal({
    ...
    public storePatron(): void {
        ...
        if (
            ...
            this.dataForm.tipo_patron == "" ||
            this.dataForm.tipo_patron == "Seleccione" ||
            this.dataForm.tipo_patron == null
        ) {
            this.$swal({
                title: "Complete los datos !",
                icon: "warning"
            ...
            if (this.datosBlanco) {
                axios
                    ...
                    .then(res => {
                        if (res.data.data.estado == "No") {
                            this.$swal({
                                title: "El patrón ha sido rechazado!",
                                icon: "warning"
                            });
                        } else {
                            this.$swal({
                                title: "El patrón ha sido aprobado con éxito.",
                                icon: "success"
                            });
                        }
                        this.getListado();
    ...
    public userRespon() {
        axios
            .get("get-datos-users-" + this.nameFormulario)
            .then(res => {
                let request = res.data.data;
                this.usersR = request.name;
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
     ...
     * @version 1.0.0
     */
    public obtenerPozos(): void{

        this.dataForm["p_grandes"] = this.dataForm['p_grandes'];
        this.dataForm["p_pequeños"] = this.dataForm['p_pequeños'];
        if(this.dataForm["p_grandes"] >= 50 || this.dataForm["p_pequeños"] >= 49){
            this.$swal({
                title: "El numero maximo de pozos grandes es de 49 y el numero maximo de pozos pequeños es de 48 !",
                icon: "warning"
            });
        } else {
            axios
            .post("pozos-" + this.nameFormulario, this.dataForm)
            .then(res => {
                let request = res.data.data[0]['resultado'];
                this.totalPozos = request;
    ...
    public storeDuplicado(dataElement: object) {
        ...
        this.dataForm["resultado_general"] = this.dataForm.resultadoGFinal;

        if (
            this.dataForm["metodo"] == "" ||
            this.dataForm["metodo"] == null ||
            this.dataForm["metodo"] == "Seleccione" ||
            this.dataForm.fecha_siembra == "" ||
            this.dataForm.fecha_siembra == null ||
            this.dataForm.hora_siembra == "" ||
            this.dataForm.hora_siembra == null
        ) {
        } else {
     ...
     * @version 1.0.0
     */
    public exportTableGoogleIp(divName) {
        if (divName == "xlsx") {
            this.$swal({
                title: "Cargando datos",
                allowOutsideClick: false,
