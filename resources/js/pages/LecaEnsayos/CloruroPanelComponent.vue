                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            ></table-column>
                            <table-column
                                show="volumen_gastado"
                                label="Volumen AgNO3 mL (gastado)"
                            ></table-column>
                            <table-column
                                show="concentracion"
                                label="Concentración AgNO3"
                            ></table-column>
                            <table-column
                                show="resultado"
                                label="Cloruro mg CI-/L"
                            >
                                <template
                                    slot-scope="row"
                                    :sortable="false"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >pH de ajuste de la muestra:</label
                                            >
                                            <div class="col-md-5">
                                                <input
                                                   class="form-group form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                >Volumen AgNO3 mL (gastado):</label
                                            >
                                            <div class="col-md-5">
                                                <!-- <input
                                                   class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.volumen_gastado
                                                    "
                                                /> -->
                                                <currency-input
                                                    v-model="dataForm.volumen_gastado"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <input-operation
                                            ...
                                            "
                                            :number-four="
                                                parseFloat(this.ultimoBlanco)
                                            "
                                            :key="
                                                dataForm.volumen_muestra +
                                                    dataForm.volumen_gastado 
                                            "
                                            :cantidad-decimales="decimalPatron"
                                            :value="dataForm"
                                            operation="cloruropatron"
                                            prefix=" "
                                        ></input-operation>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        <label
                                            class="text-inverse text-left col-6 required"
                                            >Control concentrado del estandar</label
                                        >
                                        <div class="col-md-5">
                                            <input
                                               class="form-group form-control"
                        ...
                        <div class="panel" data-sortable-id="ui-general-1">
                            <div class="modal-body">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <input-operation
                                        name-field="resultadoc"
                                        :number-one="
                                            parseFloat(dataForm.volumen_muestra)
                                        "
                                        :number-two="
                                            parseFloat(dataForm.volumen_gastado)
                                        "
                                        :number-three="
                                            parseFloat(datoConcentracion)
                                        "
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" id="VerDetalles">
                            ...
                            <dd class="col-9 mt-5">
                                {{ dataShow.resultado_completo }}
                            </dd>

                            <dt class="text-inverse text-left col-3 mt-5">
                                pH de ajuste de la muestra:
                            </dt>
                            <dd class="col-9 mt-5">
                                {{ dataShow.ph }}
                            </dd>
                            ...
                            <dt class="text-inverse text-left col-3 mt-5">
                                Volumen AgNO3 mL (gastado)
                            </dt>
                            <dd class="col-9 mt-5">
                                {{ dataShow.volumen_gastado }}
                            </dd>
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                ...
                                <div v-if="item.tipo == 'Duplicado'">
                                    <div
                                        v-for="(itema,
                                        key) in item.lc_dpr_pr_cloruros"
                                        :key="key"
                                    >
                                        <div
                                            v-if="
...
export default class CloruroPanelComponent extends Vue {
    ...
    public storeBlanco(): void {
        ...
        if (
            this.dataForm["ph"] == "" ||
            this.dataForm["ph"] == null ||
            this.dataForm["temperatura"] == "" ||
            this.dataForm["temperatura"] == null ||
            this.dataForm["volumen_muestra"] == "" ||
            this.dataForm["volumen_muestra"] == null ||
            this.dataForm["volumen_gastado"] == "" ||
            this.dataForm["volumen_gastado"] == null ||
    ...
    public storePatron(): void {
        ...
        this.dataForm["concentracion"] = this.datoConcentracion;
        this.dataForm["resultado_completo"] = this.dataForm.resultadob;
        this.dataForm["resultado"] = this.dataForm.resultadob.toFixed(
            this.decimalBlanco
        );
        if (
            this.dataForm["temperatura"] == "" ||
    ...
    public cargaConcentracion() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.datoConcentracion = res.data.data["concentracion_agno"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
    ...
    public cargaUltimoBlanco() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.ultimoBlanco = res.data.data["volumen_gastado"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
    ...
    public storeDuplicado(dataElement: object) {
        ...
        this.dataForm["concentracion"] = this.datoConcentracion;
        this.dataForm["resultado_completo"] = this.dataForm.resultadoc;
        this.dataForm["resultado"] = this.dataForm.resultadoc.toFixed(
            this.decimalBlanco
        );
        if (
