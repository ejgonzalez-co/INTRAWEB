    ...
    <div class="m-1">
        <div>
            ...
            <h1 class="page-header text-center m-b-35">
                Vista principal para la ejecución del ensayo de pH
            </h1>
            <div class="row m-5">
                <div class="col">
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="panel" data-sortable-id="ui-general-1">
                        ...
                        <div class="panel" data-sortable-id="ui-general-1">
                            ...
                            <div class="panel-body">
                                <h5>Ingrese la Información para la ejecución del STD</h5>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <!-- Proceso -->
                                        <div class="form-group row m-b-15">
...
export default class PhPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        ...
        if (
            this.dataForm["ph1"] == "" ||
            this.dataForm["ph1"] == null ||
            this.dataForm["ph2"] == "" ||
            this.dataForm["ph2"] == null ||
            this.dataForm["temperatura_ph"] == "" ||
            this.dataForm["temperatura_ph"] == null
        ) {
            this.$swal({
    ...
    public cargaUltimoBlanco() {
        axios
            ...
            .then(res => {
                // Llena la lista de datos
                this.ultimoBlanco = res.data.data["ph2"];
            })
            .catch(err => {
                console.log("Error al obtener la lista.");
            });
     ...
     *
     * @author Manuel Marin. - Enero. 23 - 2023
     * @version 1.0.0
     *
     ...
     * datos de la procentual relativa
     *
     * @author Leo Herrera. - Marzo. 30 - 2023
     * @version 1.0.0
     */
