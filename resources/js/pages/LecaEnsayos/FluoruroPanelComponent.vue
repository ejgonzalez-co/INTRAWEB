                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        <div class="row" id="VerDetalles">
                            ...
                            <dt class="text-inverse text-left col-3">mg F-/L:</dt>
                            <dd class="col-9">{{ dataShow.mg_fl }}</dd>
...
export default class FluoruroPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        ...
        if (
            ...
            this.dataForm.mv == "" ||
            this.dataForm.mv == null ||
            this.dataForm.mg_fl == "" ||
            this.dataForm.mg_fl == null
        ) {
            this.$swal({
    ...
    public datosAdd(dataElement: object) {
        this.dataForm["add2"] = dataElement["mg_fl"];

        axios
            .get("get-ensayop-" + this.nameFormulario + "/" + dataElement["id"])
            .then(res => {
                this.dataForm["add1"] = res.data.data["mg_fl"];
            })
            .catch(error => {});
    }
