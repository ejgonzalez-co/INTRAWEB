                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-heading ui-sortable-handle">
                                <h4 class="panel-title">
                                    <strong
                                        >Seleccione con que fórmula calculará la
                                        Alcalinidad</strong
                                    >
                                </h4>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <input-operation
                                            ...
                                            "
                                            :number-two="
                                                parseFloat(dataForm.volumen_fa)
                                            "
                                            :number-three="
                                                parseFloat(dataForm.volumen_ma)
                                            "
                                            :number-four="
                                                parseFloat(
                                                    dataForm.normalidad_soluciona
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row m-b-15">
                                        ...
                                        <input-operation
                                            ...
                                            "
                                            :number-two="
                                                parseFloat(dataForm.volumen_fb)
                                            "
                                            :number-three="
                                                parseFloat(dataForm.volumen_mb)
                                            "
                                            :number-four="
                                                parseFloat(
                                                    dataForm.normalidad_solucionb
...
export default class AlcalinidadEnsayoComponent extends Vue {
    ...
    public storeEnsayo(): void {
        ...
        if (this.dataForm.alcalinidad_select == "≤ 20 mg/L") {
            ...
            this.dataForm[
                "alcalinidad_total"
            ] = this.dataForm.resultadoa.toFixed(this.decimalEnsayo);
            ...
            if (this.dataForm.alcalinidad_select == "≥ 20 mg/L") {
                ...
                this.dataForm[
                    "alcalinidad_total"
                ] = this.dataForm.resultadob.toFixed(this.decimalEnsayo);
        ...
        if (
            ...
            if (this.datosBlanco) {
                this.dataForm["resultado"] = this.dataForm["resultado"];
                this.dataForm["alcalinidad_total"] = this.dataForm[
                    "resultado"
                            ...
                            if (res.data.data == "Error blanco") {
                                ...
                                if (res.data.data == "Error patron") {
                                    ...
                                    if (res.data.data == "Error ensayo") {
                                        this.$swal({
                                            title: "Verificar configuración de periocidad !",
                                            icon: "warning"
                                        });
                                    } else {
                                    }
