                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            ></table-column>
                            <table-column
                                show="sustanciasFlotantes"
                                label="Sustancias flotantes"
                            ></table-column>
                            <table-column
                                show="user_name"
                                label="Analista"
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            ...
                                            <input-operation
                                                name-field="sustanciasFlotantes"
                                                :number-one="
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6 required"
                                                ><i class="icon-ostatus-colored"></i>Sustancias flotantes: </label
                                            >
                                            <div class="col-md-5">
                                                <input
                                                     class="form-group form-control"
                        ...
                        >
                            ...
                            <div style="padding: 15px">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraBlanco.sustanciasFlotantes }}
                                    </dd>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                      ...
                                      <!-- User Name Field -->
                                    <dt class="text-inverse text-left col-2">
                                        Expresión de sustanciasFlotantes:
                                    </dt>
                                    <dd class="col-4">
                            ...
                            <div style="padding: 15px">
                               <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <dd class="col-4">
                                        {{ muestraPatron.sustanciasFlotantes }}
                                    </dd>
...
export default class CloruroPanelComponent extends Vue {
    ...
    public storeBlanco(): void {
        ...
        if (
            ...
            this.dataForm["sustanciasFlotantes"] == "" ||
            this.dataForm["sustanciasFlotantes"] == null 
        ) {
            this.$swal({
        ...
        axios
            ...
            .then(res => {
                if (res.data.data == "no") {
                    ...
                    // this.dataForm["sustanciasFlotantes"] = res.data.data.sustanciasFlotantes;
    ...
    public storePorcentualRelativa(dataElement: object) {
        ...
        this.dataForm["resultado_completo"] = this.dataForm["sustanciasFlotantes"];
        this.dataForm["sustanciasFlotantes"] = this.dataForm["sustanciasFlotantes"].toFixed(1);
        if (
            this.dataForm.add2 == "" ||
    ...
    public exportDataTable(divName) {
        if (
            (this.contadorFiltro > 0 && this.searchFields["final"]) ||
            (this.contadorFiltro > 0 && this.searchFields["inicio"])
        ) {
            if (divName == "xlsx") {
                // axios
                //     .post(
                ...
                axios
                    ...
                    .then(res => {
                        ...
                        this.downloadFile(res.data, "Reporte", "xlsx");
                    })
                    .catch(err => {});
            }
        } else {
            this.$swal({
                title: "Debes filtrar primero los datos!",
                icon: "warning"
            });
        }
    }
