...
export default class HeterotroficasPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        ...
        if (
            this.dataForm.resultado_general == "" ||
            this.dataForm.resultado_general == null
        ) {
            this.$swal({
    ...
    public obtenerDosis(): void{
        ...
        if(this.dataForm["p_positivos"] >= 85){
            this.$swal({
                title: "El numero maximo para consultar es 84!",
                icon: "warning"
            });
        } else {
            axios
