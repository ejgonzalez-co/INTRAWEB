                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                ...
                                                >Concentración(mg/L)1:</label
                                            >
                                            <div class="col-md-5" v-if="this.nameFormulario == 'carbono'">
                                                <!-- <input
                                                    class="form-group form-control"
                                                    type="number"
                                                    name="concentracionB"
                                                    value="
                                                        dataForm.concentracionB
                                                    "
                                                    
                                                /> -->
                                                <currency-input
                                                    name="concentracionB"
                                                    v-model="dataForm.concentracionB"
                                                    :currency="{'prefix': ''}"
                                                    locale="es"
                                                    :precision="3"
                                                    class="form-control"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row m-b-15">
                                            <label
                                                class="text-inverse text-left col-6"
                                                >Concentración(mg/L)3:</label
                                            >
                                            <div class="col-md-6" v-if="this.nameFormulario == 'carbono'">
                                                <!-- <input
                                                    class="form-group form-control"
                                                    type="number"
                                                    v-model="
                                                        dataForm.concentracion
                                                    "
                                                /> -->
                                                <currency-input
...
export default class AluminioPanelComponent extends Vue {
    /**
    ...
    public storeBlanco(): void {
        console.log('fera if ', this.nameFormulario);

    
        console.log('dentro if ', this.nameFormulario);
        ...
        if (this.nameFormulario != 'carbono') {
