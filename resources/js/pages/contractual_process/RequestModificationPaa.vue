<template>
   <div>
      ...
      <div class="modal fade" id="modal-form-request-modification-paa" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg">
            <form @submit.prevent="save()" id="form-request-modification-paa">
               <div class="modal-content border-0">
                  <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">Solicitar modificación del PAA</h4>
...
<script lang="ts">
   ...
   /**
    * Componente para solicitar modificacion del plan anual de adquisiones
    *
    * @author Carlos Moises Garcia T. - Jul. 12 - 2021
    * @version 1.0.0
    */
   @Component
   export default class RequestModificationPaa extends Vue {
      ...
      public loadData(dataElement: object): void {
         ...
         if (dataElement) {
            ...
            $(`#modal-form-request-modification-paa`).modal('show');
         } 
      }
      ...
      public store() {
         ...
         axios.post('request-modification-paa', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
         .then((res) => {
            ...
            if (res.data.type_message) {
               ...
               if (res.data.type_message == "success") {
                  ...
                  $(`#modal-form-request-modification-paa`).modal('toggle');
