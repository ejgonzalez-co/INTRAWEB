<template>
   <div>
      ...
      <div class="modal fade" id="modal-form-process-modification-request-paa" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg">
            <form @submit.prevent="save()" id="form-process-modification-request-paa">
               <div class="modal-content border-0">
                  <div class="modal-header bg-blue">
                        <h4 class="modal-title text-white">Procesar solicitud de modificación</h4>
                  ...
                  <div class="modal-body">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group row m-b-15">
                              <label class="col-form-label col-md-3 required" for="process_request">¿Qué desea hacer?:</label>
                              <div class="col-md-9">
                                 <select class="form-control" name="" id="" v-model="dataForm.process_request">
                                    <option value="1">Aprobar modificación</option>
                                    <option value="2">Rechazar modificación</option>
                                 </select>
                                 <small></small>
                              </div>
                           </div>
                     ...
                     <div v-if="dataForm.process_request == 2" class="panel" data-sortable-id="ui-general-1">
                        <!-- begin panel-heading -->
                        ...
                        <div class="panel-body">
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 <!-- Observation Field -->
                                 <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-2 required" for="observation">{{ 'trans.Observation' | trans }}:</label>
                                    <div class="col-md-9">
                                       <textarea name="observation" cols="50" rows="5" id="observation" class="form-control" v-model="dataForm.observation" required></textarea>
...
<script lang="ts">
   ...
   /**
    * Componente para procesar la solicitud de modificacion del plan anual de adquisiones
    *
    * @author Carlos Moises Garcia T. - Jul. 13 - 2021
    * @version 1.0.0
    */
   @Component
   export default class ProcessModificationRequestPaa extends Vue {
      ...
      public loadData(dataElement: object): void {
         ...
         if (dataElement) {
            ...
            // Agrega datos al fomrulario
            this.dataForm.id = data.id;

            // Valida que exista solicitudes de modificacion
            if (data.paa_modification_request) {
               this.dataForm.request_id = data.paa_modification_request[0].id;
            }
            
            // this.dataForm.user_leader_id = data.user_leader_id;

            $(`#modal-form-process-modification-request-paa`).modal('show');
         } 
      }
      ...
      public store() {
         ...
         axios.post('process-modification-request-paa', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
         .then((res) => {
            ...
            if (res.data.type_message) {
               ...
               if (res.data.type_message == "success") {
                  ...
                  $(`#modal-form-process-modification-request-paa`).modal('toggle');
