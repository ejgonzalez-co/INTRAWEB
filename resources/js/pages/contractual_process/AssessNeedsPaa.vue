<template>
   <div>
      <!-- begin #modal-view-assess-needs-paa -->
      <div class="modal fade" id="modal-form-assess-needs-paa" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-xl">
            <form @submit.prevent="save()" id="form-assess-needs-paa" enctype="multipart/form-data">
               <div class="modal-content border-0">
                  <div class="modal-header bg-blue">
                     <h4 class="modal-title text-white">Evaluar necesidades del proceso</h4>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-2 required" for="sewerage">{{ 'trans.What would you like to do?' | trans }}:</label>
                                    <div class="col-md-9">
                                       <select name="" id="" class="form-control" v-model="dataForm.process_evaluation" required>
                                          <option value="Aprobar">Validado</option>
      ...
      <!-- end #modal-view-assess-needs-paa -->
   </div>
</template>
<script lang="ts">
    ...
    */
   @Component
   export default class AssessNeedsPaa extends Vue {
      ...
      public loadData(dataElement: object): void {
         ...
         if (dataElement) {
            ...
            this.dataForm.pc_needs = data.id;      

            $(`#modal-form-assess-needs-paa`).modal('show');
         }
      }
      ...
      public store() {
         ...
         axios.post('assess-needs-paa', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
         .then((res) => {
            ...
            if (res.data.data) {
               ...
               Object.assign((this.$parent as any)._findElementById(this.dataForm['pc_needs'], false), res.data.data);
            }
            // Cierra el swal de guardando datos
            (this.$swal as any).close();
            // Cierra fomrulario modal
            $('#modal-form-assess-needs-paa').modal('hide');
