<template>
   <div>
      ...
      <div class="modal fade" id="modal-form-evaluate-budget" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg">
               <form @submit.prevent="save()" id="form-evaluate-budget">
                  <div class="modal-content border-0">
                     <div class="modal-header bg-blue">
                           <h4 class="modal-title text-white">Procesar</h4>
                     ...
                     <div class="modal-body">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group row m-b-15">
                                 <label class="col-form-label col-md-3 required" for="process_budget">¿Qué desea hacer?:</label>
                                 <div class="col-md-9">
                                    <select class="form-control" name="" id="" v-model="dataForm.process_budget">
                                       <option value="1">Validado por presupuesto</option>
                                       <option value="2">Devolver para ajustes de presupuesto</option>
                                    </select>
                                    <small></small>
                                 </div>
                              </div>
                        ...
                        <div v-if="dataForm.process_budget == 2"  class="panel" data-sortable-id="ui-general-1">
                           <!-- begin panel-heading -->
...
<script lang="ts">
   ...
   /**
    * Componente para la aprobacion o devolucion del presupuesto de las necesidades
    *
    * @author Carlos Moises Garcia T. - Jun. 28 - 2021
    * @version 1.0.0
    */
   @Component
   export default class EvaluateBudget extends Vue {
      ...
      public loadData(dataElement: object): void {
         ...
         if (dataElement) {
            ...
            if (data.pc_alternative_budget_id) {
               this.dataForm.type_need = 'investment';
               this.dataForm.need_id = data.alternative_budgets.investment_technical_sheets.needs.id;
               this.dataForm.investment_technical_sheets_id = data.alternative_budgets.investment_technical_sheets.id;
            } else {
               this.dataForm.type_need = 'functioning';
               this.dataForm.need_id = data.needs.id;
            }

            $(`#modal-form-evaluate-budget`).modal('show');
         } 
      }
      ...
      public store() {
         ...
         axios.post('evaluate-budget-paa', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
         .then((res) => {
            ...
            if (res.data.type_message) {
               ...
               if (res.data.type_message == "success") {
                  ...
                  $(`#modal-form-evaluate-budget`).modal('toggle');
