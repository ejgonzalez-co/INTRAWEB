                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, key) in getDataColumValue" :key="key">
                            ...
                            <td>
                                ...
                                <button v-if="isRemove" type="button" @click="dropElementList(key)" :class="[classButtonDropElement, 'btn btn-icon btn-sm']">
 ...
 */
@Component
export default class DynamicListLecaComponent extends Vue {
