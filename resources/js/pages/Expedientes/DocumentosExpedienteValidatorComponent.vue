 ...
 */
@Component
export default class DocumentosExpedienteValidatorComponent extends Vue {
     ...
     */
     public validar_documento_expediente(codigo: any): void {
        ...
        axios.post('validar-documento-expediente-codigo/'+codigo)
        .then((res) => {
    ...
    public validar_adjunto_documento(): void {
        ...
        axios
            .post("validar-adjunto-documento-expediente", this.makeFormData(), {
    ...
    /**
     * Asigna al dataForm el archivo y el hash del documento adjuntado
     *
     * @author Seven Soluciones Informáticas S.A.S. - Mar. 17 - 2025
     * @version 1.0.0
     */
