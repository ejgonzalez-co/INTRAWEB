...
class RutinaFuncionario implements FromView, WithEvents {
     ...
     *
     * @author Andres Stiven Pinzón G - Jun . 04 - 2021
     * @version 1.0.0
     *
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $titleCellRange = 'A1:'.$this->column.'1'; // All headers

                $event->sheet->getDelegate()->getStyle($titleCellRange)->applyFromArray([
                ...
                $cellRange = 'A2:'.$this->column.'2'; // All headers
                ...
                // dd("hola desde request",$this->data);
                // $position = 1;
                // foreach($this->data as $information){
                //     if($information['current_hourmeter']){
                //         $event->sheet->getDelegate()->getStyle('U'+$position)
                //         ->getNumberFormat()
                //         ->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
                //     }else if($information['current_mileage']){
                //         // // dd("posicion",$position);
                //         // // $information['performance_by_gallon']= intval($information['performance_by_gallon']);
                //         // dd("rendimiento",$information['performance_by_gallon']);
                //         // $event->sheet->getDelegate()->getStyle('U',$position)
                //         // ->getNumberFormat()
                ...
                $event->sheet->getStyle('A3:'.strtoupper($this->column).(count($this->data)+2))->applyFromArray([
                    'borders' => [
                        'allBorders' => [
                            'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                            'color' => ['argb' => '000000'],
